...
/**
 * Table class for fin_department
 */
class FinDepartment extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'fin_department';
        $this->TableName = 'fin_department';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`fin_department`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->_default->Lookup = new Lookup('default', 'fin_department', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
            case "pt-BR":
                $this->_default->Lookup = new Lookup('default', 'fin_department', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`fin_department`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("FinDepartmentList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "FinDepartmentEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "FinDepartmentAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "FinDepartmentView";
            case Config("API_ADD_ACTION"):
                return "FinDepartmentAdd";
            case Config("API_EDIT_ACTION"):
                return "FinDepartmentEdit";
            case Config("API_DELETE_ACTION"):
                return "FinDepartmentDelete";
            case Config("API_LIST_ACTION"):
                return "FinDepartmentList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("FinDepartmentView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("FinDepartmentView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "FinDepartmentAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "FinDepartmentAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FinDepartmentEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FinDepartmentAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("FinDepartmentDelete", $this->getUrlParm());
    }
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM `fin_department`";
    ...
    public function rowInserting($rsold, &$rsnew)
    {
        ...
        $rsnew['organizationId'] = CurrentOrganizationID();
