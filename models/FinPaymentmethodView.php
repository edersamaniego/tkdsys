 ...
 * Page class
 */
class FinPaymentmethodView extends FinPaymentmethod
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinPaymentmethodView";
        ...
        if ($url != "") {
            ...
            if ($this->IsModal) { // Show as modal
                ...
                if ($pageName != $this->getListUrl()) { // Not List page
                    ...
                    if ($pageName == "FinPaymentmethodView") {
                        $row["view"] = "1";
                    }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FinPaymentmethodList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("FinPaymentmethodList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "FinPaymentmethodList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "FinPaymentmethodList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("FinPaymentmethodList"), "", $this->TableVar, true);
        $pageId = "view";
