...
/**
 * Table class for fin_costcenter
 */
class FinCostcenter extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'fin_costcenter';
        $this->TableName = 'fin_costcenter';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`fin_costcenter`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->costCenter->InputTextType = "text";
        $this->Fields['costCenter'] = &$this->costCenter;
        ...
        $this->organization->InputTextType = "text";
        switch ($CurrentLanguage) {
            case "en-US":
                $this->organization->Lookup = new Lookup('organization', 'fed_federation', false, 'id', ["federation","","",""], [], [], [], [], [], [], '', '', "`federation`");
                break;
            case "pt-BR":
                $this->organization->Lookup = new Lookup('organization', 'fed_federation', false, 'id', ["federation","","",""], [], [], [], [], [], [], '', '', "`federation`");
                break;
        ...
        $this->organization->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->_default->Lookup = new Lookup('default', 'fin_costcenter', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
            case "pt-BR":
                $this->_default->Lookup = new Lookup('default', 'fin_costcenter', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`fin_costcenter`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->costCenter->DbValue = $row['costCenter'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("FinCostcenterList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "FinCostcenterEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "FinCostcenterAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "FinCostcenterView";
            case Config("API_ADD_ACTION"):
                return "FinCostcenterAdd";
            case Config("API_EDIT_ACTION"):
                return "FinCostcenterEdit";
            case Config("API_DELETE_ACTION"):
                return "FinCostcenterDelete";
            case Config("API_LIST_ACTION"):
                return "FinCostcenterList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("FinCostcenterView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("FinCostcenterView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "FinCostcenterAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "FinCostcenterAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FinCostcenterEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FinCostcenterAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("FinCostcenterDelete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->costCenter->EditValue = $this->costCenter->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->costCenter);
                    $doc->exportCaption($this->schoolId);
                    $doc->exportCaption($this->masterSchoolId);
                    $doc->exportCaption($this->organization);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->costCenter);
                        $doc->exportField($this->schoolId);
                        $doc->exportField($this->masterSchoolId);
                        $doc->exportField($this->organization);
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM `fin_costcenter`";
    ...
    public function rowInserting($rsold, &$rsnew)
    {
        ...
        $rsnew['registerDate'] = ExecuteScalar('SELECT NOW()');
