    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($curVal != "") {
                ...
                $this->federationId->ViewValue = $this->federationId->Lookup !== null && is_array($this->federationId->lookupOptions()) ? $curVal : null;
            }
            if ($this->federationId->ViewValue !== null) { // Load from cache
                $this->federationId->EditValue = array_values($this->federationId->lookupOptions());
