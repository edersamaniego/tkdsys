 ...
 * Page class
 */
class ConfCityDelete extends ConfCity
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConfCityDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ConfCityList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ConfCityList"); // Return to list
                return;
            }
        }
