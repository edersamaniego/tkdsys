 ...
 * Page class
 */
class FinCreditDelete extends FinCredit
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinCreditDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FinCreditList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("FinCreditList"); // Return to list
            return;
        }
