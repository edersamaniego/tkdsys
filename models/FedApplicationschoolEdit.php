 ...
 * Page class
 */
class FedApplicationschoolEdit extends FedApplicationschool
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedApplicationschoolEdit";
    ...
    protected function validateForm()
    {
        ...
        if (in_array("fed_school", $detailTblVar) && $detailPage->DetailEdit) {
            $validateForm = $validateForm && $detailPage->validateGridForm();
        }
        $detailPage = Container("FedLicenseschoolGrid");
        if (in_array("fed_licenseschool", $detailTblVar) && $detailPage->DetailEdit) {
            $validateForm = $validateForm && $detailPage->validateGridForm();
        }
