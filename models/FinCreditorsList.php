 ...
 * Page class
 */
class FinCreditorsList extends FinCreditors
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinCreditorsList";
    ...
    public $FormName = "ffin_creditorslist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "FinCreditorsAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "FinCreditorsDelete";
        $this->MultiUpdateUrl = "FinCreditorsUpdate";
    ...
    public function run()
    {
        ...
        $this->telephone1->Visible = false;
        $this->telephone2->Visible = false;
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "ffin_creditorssrch");
        }
        $filterList = Concat($filterList, $this->id->AdvancedSearch->toJson(), ","); // Field id
        $filterList = Concat($filterList, $this->organizationId->AdvancedSearch->toJson(), ","); // Field organizationId
        ...
        $filterList = Concat($filterList, $this->creditor->AdvancedSearch->toJson(), ","); // Field creditor
        $filterList = Concat($filterList, $this->uniqueCode->AdvancedSearch->toJson(), ","); // Field uniqueCode
        $filterList = Concat($filterList, $this->IDcode->AdvancedSearch->toJson(), ","); // Field IDcode
        $filterList = Concat($filterList, $this->adress->AdvancedSearch->toJson(), ","); // Field adress
        ...
        $filterList = Concat($filterList, $this->telephone1->AdvancedSearch->toJson(), ","); // Field telephone1
        $filterList = Concat($filterList, $this->telephone2->AdvancedSearch->toJson(), ","); // Field telephone2
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "ffin_creditorssrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        $this->organizationId->AdvancedSearch->SearchValue = @$filter["x_organizationId"];
        $this->organizationId->AdvancedSearch->SearchOperator = @$filter["z_organizationId"];
        $this->organizationId->AdvancedSearch->SearchCondition = @$filter["v_organizationId"];
        $this->organizationId->AdvancedSearch->SearchValue2 = @$filter["y_organizationId"];
        $this->organizationId->AdvancedSearch->SearchOperator2 = @$filter["w_organizationId"];
        $this->organizationId->AdvancedSearch->save();
        ...
        // Field creditor
        $this->creditor->AdvancedSearch->SearchValue = @$filter["x_creditor"];
        $this->creditor->AdvancedSearch->SearchOperator = @$filter["z_creditor"];
        $this->creditor->AdvancedSearch->SearchCondition = @$filter["v_creditor"];
        $this->creditor->AdvancedSearch->SearchValue2 = @$filter["y_creditor"];
        $this->creditor->AdvancedSearch->SearchOperator2 = @$filter["w_creditor"];
        $this->creditor->AdvancedSearch->save();

        // Field uniqueCode
        $this->uniqueCode->AdvancedSearch->SearchValue = @$filter["x_uniqueCode"];
        $this->uniqueCode->AdvancedSearch->SearchOperator = @$filter["z_uniqueCode"];
        $this->uniqueCode->AdvancedSearch->SearchCondition = @$filter["v_uniqueCode"];
        $this->uniqueCode->AdvancedSearch->SearchValue2 = @$filter["y_uniqueCode"];
        $this->uniqueCode->AdvancedSearch->SearchOperator2 = @$filter["w_uniqueCode"];
        $this->uniqueCode->AdvancedSearch->save();

        // Field IDcode
        $this->IDcode->AdvancedSearch->SearchValue = @$filter["x_IDcode"];
        $this->IDcode->AdvancedSearch->SearchOperator = @$filter["z_IDcode"];
        $this->IDcode->AdvancedSearch->SearchCondition = @$filter["v_IDcode"];
        $this->IDcode->AdvancedSearch->SearchValue2 = @$filter["y_IDcode"];
        $this->IDcode->AdvancedSearch->SearchOperator2 = @$filter["w_IDcode"];
        $this->IDcode->AdvancedSearch->save();

        // Field adress
        $this->adress->AdvancedSearch->SearchValue = @$filter["x_adress"];
        $this->adress->AdvancedSearch->SearchOperator = @$filter["z_adress"];
        $this->adress->AdvancedSearch->SearchCondition = @$filter["v_adress"];
        $this->adress->AdvancedSearch->SearchValue2 = @$filter["y_adress"];
        $this->adress->AdvancedSearch->SearchOperator2 = @$filter["w_adress"];
        $this->adress->AdvancedSearch->save();
        ...
        // Field telephone1
        $this->telephone1->AdvancedSearch->SearchValue = @$filter["x_telephone1"];
        $this->telephone1->AdvancedSearch->SearchOperator = @$filter["z_telephone1"];
        $this->telephone1->AdvancedSearch->SearchCondition = @$filter["v_telephone1"];
        $this->telephone1->AdvancedSearch->SearchValue2 = @$filter["y_telephone1"];
        $this->telephone1->AdvancedSearch->SearchOperator2 = @$filter["w_telephone1"];
        $this->telephone1->AdvancedSearch->save();

        // Field telephone2
        $this->telephone2->AdvancedSearch->SearchValue = @$filter["x_telephone2"];
        $this->telephone2->AdvancedSearch->SearchOperator = @$filter["z_telephone2"];
        $this->telephone2->AdvancedSearch->SearchCondition = @$filter["v_telephone2"];
        $this->telephone2->AdvancedSearch->SearchValue2 = @$filter["y_telephone2"];
        $this->telephone2->AdvancedSearch->SearchOperator2 = @$filter["w_telephone2"];
        $this->telephone2->AdvancedSearch->save();
    ...
    protected function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->creditor;
        $searchFlds[] = &$this->uniqueCode;
        $searchFlds[] = &$this->IDcode;
        $searchFlds[] = &$this->adress;
        $searchFlds[] = &$this->number;
        $searchFlds[] = &$this->neighborhood;
        $searchFlds[] = &$this->telephone1;
        $searchFlds[] = &$this->telephone2;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->creditor); // creditor
            $this->updateSort($this->uniqueCode); // uniqueCode
            $this->updateSort($this->IDcode); // IDcode
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->id->setSort("");
                $this->organizationId->setSort("");
                $this->masterSchoolId->setSort("");
                $this->_userId->setSort("");
                $this->schoolId->setSort("");
                $this->creditor->setSort("");
                $this->uniqueCode->setSort("");
                $this->IDcode->setSort("");
                $this->adress->setSort("");
                $this->number->setSort("");
                ...
                $this->state->setSort("");
                $this->city->setSort("");
                $this->telephone1->setSort("");
                $this->telephone2->setSort("");
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"ffin_creditorslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"ffin_creditorslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("creditor", $this->createColumnOption("creditor"));
            $option->add("uniqueCode", $this->createColumnOption("uniqueCode"));
            $option->add("IDcode", $this->createColumnOption("IDcode"));
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"ffin_creditorssrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"ffin_creditorssrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="ffin_creditorslist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="ffin_creditorslist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"ffin_creditorssrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
