...
/**
 * Table class for fed_instructorlevels
 */
class FedInstructorlevels extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'fed_instructorlevels';
        $this->TableName = 'fed_instructorlevels';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`fed_instructorlevels`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`fed_instructorlevels`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("FedInstructorlevelsList");
    }
    ...
    {
        global $Language;
        if ($pageName == "FedInstructorlevelsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "FedInstructorlevelsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "FedInstructorlevelsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "FedInstructorlevelsView";
            case Config("API_ADD_ACTION"):
                return "FedInstructorlevelsAdd";
            case Config("API_EDIT_ACTION"):
                return "FedInstructorlevelsEdit";
            case Config("API_DELETE_ACTION"):
                return "FedInstructorlevelsDelete";
            case Config("API_LIST_ACTION"):
                return "FedInstructorlevelsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("FedInstructorlevelsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("FedInstructorlevelsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "FedInstructorlevelsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "FedInstructorlevelsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FedInstructorlevelsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FedInstructorlevelsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("FedInstructorlevelsDelete", $this->getUrlParm());
    }
