 ...
 * Page class
 */
class FinDebitView extends FinDebit
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinDebitView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FinDebitList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "FinDebitList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "FinDebitList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
