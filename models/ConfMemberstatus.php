...
/**
 * Table class for conf_memberstatus
 */
class ConfMemberstatus extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'conf_memberstatus';
        $this->TableName = 'conf_memberstatus';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`conf_memberstatus`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`conf_memberstatus`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ConfMemberstatusList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ConfMemberstatusView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ConfMemberstatusEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ConfMemberstatusAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ConfMemberstatusView";
            case Config("API_ADD_ACTION"):
                return "ConfMemberstatusAdd";
            case Config("API_EDIT_ACTION"):
                return "ConfMemberstatusEdit";
            case Config("API_DELETE_ACTION"):
                return "ConfMemberstatusDelete";
            case Config("API_LIST_ACTION"):
                return "ConfMemberstatusList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ConfMemberstatusView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ConfMemberstatusView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ConfMemberstatusAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ConfMemberstatusAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ConfMemberstatusEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ConfMemberstatusAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ConfMemberstatusDelete", $this->getUrlParm());
    }
