 ...
 * Page class
 */
class FedVideosubsectionView extends FedVideosubsection
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedVideosubsectionView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FedVideosubsectionList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "FedVideosubsectionList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "FedVideosubsectionList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupOtherOptions()
    {
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("FedVideoList?" . Config("TABLE_SHOW_MASTER") . "=fed_videosubsection&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        ...
        if ($detailPageObj->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'fed_videosubsection')) {
