...
/**
 * Table class for school_class
 */
class SchoolClass extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'school_class';
        $this->TableName = 'school_class';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`school_class`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->daysByWeek->InputTextType = "text";
        $this->Fields['daysByWeek'] = &$this->daysByWeek;

        // beginnigTime
        $this->beginnigTime = new DbField(
            'school_class',
            'school_class',
            'x_beginnigTime',
            'beginnigTime',
            '`beginnigTime`',
            CastDateFieldForLike("`beginnigTime`", 4, "DB"),
            134,
            10,
            4,
            false,
        ...
        $this->beginnigTime->InputTextType = "text";
        $this->beginnigTime->DefaultErrorMessage = str_replace("%s", DateFormat(4), $Language->phrase("IncorrectTime"));
        $this->Fields['beginnigTime'] = &$this->beginnigTime;

        // endingTime
        $this->endingTime = new DbField(
            'school_class',
            'school_class',
            'x_endingTime',
            'endingTime',
            '`endingTime`',
            CastDateFieldForLike("`endingTime`", 4, "DB"),
            134,
            10,
            4,
            false,
        ...
        $this->endingTime->InputTextType = "text";
        $this->endingTime->DefaultErrorMessage = str_replace("%s", DateFormat(4), $Language->phrase("IncorrectTime"));
        $this->Fields['endingTime'] = &$this->endingTime;
        ...
        $this->limit->InputTextType = "text";
        $this->limit->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['limit'] = &$this->limit;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`school_class`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->daysByWeek->DbValue = $row['daysByWeek'];
        $this->beginnigTime->DbValue = $row['beginnigTime'];
        $this->endingTime->DbValue = $row['endingTime'];
        $this->status->DbValue = $row['status'];
        $this->limit->DbValue = $row['limit'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("SchoolClassList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "SchoolClassEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "SchoolClassAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "SchoolClassAdd";
            case Config("API_EDIT_ACTION"):
                return "SchoolClassEdit";
            case Config("API_DELETE_ACTION"):
                return "SchoolClassDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("SchoolClassView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("SchoolClassView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "SchoolClassAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "SchoolClassAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("SchoolClassEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SchoolClassAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("SchoolClassDelete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->daysByWeek->EditValue = $this->daysByWeek->CurrentValue;
        ...
        $this->beginnigTime->EditValue = FormatDateTime($this->beginnigTime->CurrentValue, $this->beginnigTime->formatPattern());
        ...
        $this->endingTime->EditValue = FormatDateTime($this->endingTime->CurrentValue, $this->endingTime->formatPattern());
        ...
        $this->limit->EditValue = $this->limit->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->daysByWeek);
                    $doc->exportCaption($this->beginnigTime);
                    $doc->exportCaption($this->endingTime);
                    $doc->exportCaption($this->status);
                    $doc->exportCaption($this->limit);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->daysByWeek);
                        $doc->exportField($this->beginnigTime);
                        $doc->exportField($this->endingTime);
                        $doc->exportField($this->status);
                        $doc->exportField($this->limit);
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM `school_class`";
