 ...
 * Page class
 */
class FinDebitDelete extends FinDebit
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinDebitDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FinDebitList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("FinDebitList"); // Return to list
            return;
        }
