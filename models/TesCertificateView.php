 ...
 * Page class
 */
class TesCertificateView extends TesCertificate
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TesCertificateView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "TesCertificateList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("TesCertificateList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "TesCertificateList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "TesCertificateList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
