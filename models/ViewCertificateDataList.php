 ...
 * Page class
 */
class ViewCertificateDataList extends ViewCertificateData
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'view_certificate_data';

    // Page object name
    public $PageObjName = "ViewCertificateDataList";
    ...
    public $FormName = "fview_certificate_datalist";
    ...
    public function __construct()
    {
        ...
        // Table object (view_certificate_data)
        if (!isset($GLOBALS["view_certificate_data"]) || get_class($GLOBALS["view_certificate_data"]) == PROJECT_NAMESPACE . "view_certificate_data") {
            $GLOBALS["view_certificate_data"] = &$this;
        }
        ...
        // Initialize URLs
        $this->AddUrl = "ViewCertificateDataAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewCertificateDataDelete";
        $this->MultiUpdateUrl = "ViewCertificateDataUpdate";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'view_certificate_data');
        }
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $tbl = Container("view_certificate_data");
                $doc = new $class($tbl);
                $doc->Text = @$content;
    ...
    public function run()
    {
        ...
        $this->next->setVisibility();
        $this->memberAge->setVisibility();
        $this->memberDOB->setVisibility();
        $this->description->setVisibility();
        $this->instructorName->setVisibility();
        $this->instructorLastName->setVisibility();
        $this->auxiliarName->setVisibility();
        $this->auxiliarLastName->setVisibility();
        $this->testDate->setVisibility();
        $this->testTime->setVisibility();
        $this->ceremonyDate->setVisibility();
        $this->city->setVisibility();
        $this->uf->setVisibility();
        $this->instructorRanking->setVisibility();
        $this->auxiliarRanking->setVisibility();
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fview_certificate_datasrch");
        }
        ...
        $filterList = Concat($filterList, $this->next->AdvancedSearch->toJson(), ","); // Field next
        ...
        $filterList = Concat($filterList, $this->instructorName->AdvancedSearch->toJson(), ","); // Field instructorName
        $filterList = Concat($filterList, $this->instructorLastName->AdvancedSearch->toJson(), ","); // Field instructorLastName
        $filterList = Concat($filterList, $this->auxiliarName->AdvancedSearch->toJson(), ","); // Field auxiliarName
        $filterList = Concat($filterList, $this->auxiliarLastName->AdvancedSearch->toJson(), ","); // Field auxiliarLastName
        ...
        $filterList = Concat($filterList, $this->instructorRanking->AdvancedSearch->toJson(), ","); // Field instructorRanking
        $filterList = Concat($filterList, $this->auxiliarRanking->AdvancedSearch->toJson(), ","); // Field auxiliarRanking
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fview_certificate_datasrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field next
        $this->next->AdvancedSearch->SearchValue = @$filter["x_next"];
        $this->next->AdvancedSearch->SearchOperator = @$filter["z_next"];
        $this->next->AdvancedSearch->SearchCondition = @$filter["v_next"];
        $this->next->AdvancedSearch->SearchValue2 = @$filter["y_next"];
        $this->next->AdvancedSearch->SearchOperator2 = @$filter["w_next"];
        $this->next->AdvancedSearch->save();
        ...
        $this->instructorName->AdvancedSearch->SearchValue = @$filter["x_instructorName"];
        $this->instructorName->AdvancedSearch->SearchOperator = @$filter["z_instructorName"];
        $this->instructorName->AdvancedSearch->SearchCondition = @$filter["v_instructorName"];
        $this->instructorName->AdvancedSearch->SearchValue2 = @$filter["y_instructorName"];
        $this->instructorName->AdvancedSearch->SearchOperator2 = @$filter["w_instructorName"];
        $this->instructorName->AdvancedSearch->save();

        // Field instructorLastName
        $this->instructorLastName->AdvancedSearch->SearchValue = @$filter["x_instructorLastName"];
        $this->instructorLastName->AdvancedSearch->SearchOperator = @$filter["z_instructorLastName"];
        $this->instructorLastName->AdvancedSearch->SearchCondition = @$filter["v_instructorLastName"];
        $this->instructorLastName->AdvancedSearch->SearchValue2 = @$filter["y_instructorLastName"];
        $this->instructorLastName->AdvancedSearch->SearchOperator2 = @$filter["w_instructorLastName"];
        $this->instructorLastName->AdvancedSearch->save();

        // Field auxiliarName
        $this->auxiliarName->AdvancedSearch->SearchValue = @$filter["x_auxiliarName"];
        $this->auxiliarName->AdvancedSearch->SearchOperator = @$filter["z_auxiliarName"];
        $this->auxiliarName->AdvancedSearch->SearchCondition = @$filter["v_auxiliarName"];
        $this->auxiliarName->AdvancedSearch->SearchValue2 = @$filter["y_auxiliarName"];
        $this->auxiliarName->AdvancedSearch->SearchOperator2 = @$filter["w_auxiliarName"];
        $this->auxiliarName->AdvancedSearch->save();

        // Field auxiliarLastName
        $this->auxiliarLastName->AdvancedSearch->SearchValue = @$filter["x_auxiliarLastName"];
        $this->auxiliarLastName->AdvancedSearch->SearchOperator = @$filter["z_auxiliarLastName"];
        $this->auxiliarLastName->AdvancedSearch->SearchCondition = @$filter["v_auxiliarLastName"];
        $this->auxiliarLastName->AdvancedSearch->SearchValue2 = @$filter["y_auxiliarLastName"];
        $this->auxiliarLastName->AdvancedSearch->SearchOperator2 = @$filter["w_auxiliarLastName"];
        $this->auxiliarLastName->AdvancedSearch->save();
        ...
        // Field instructorRanking
        $this->instructorRanking->AdvancedSearch->SearchValue = @$filter["x_instructorRanking"];
        $this->instructorRanking->AdvancedSearch->SearchOperator = @$filter["z_instructorRanking"];
        $this->instructorRanking->AdvancedSearch->SearchCondition = @$filter["v_instructorRanking"];
        $this->instructorRanking->AdvancedSearch->SearchValue2 = @$filter["y_instructorRanking"];
        $this->instructorRanking->AdvancedSearch->SearchOperator2 = @$filter["w_instructorRanking"];
        $this->instructorRanking->AdvancedSearch->save();

        // Field auxiliarRanking
        $this->auxiliarRanking->AdvancedSearch->SearchValue = @$filter["x_auxiliarRanking"];
        $this->auxiliarRanking->AdvancedSearch->SearchOperator = @$filter["z_auxiliarRanking"];
        $this->auxiliarRanking->AdvancedSearch->SearchCondition = @$filter["v_auxiliarRanking"];
        $this->auxiliarRanking->AdvancedSearch->SearchValue2 = @$filter["y_auxiliarRanking"];
        $this->auxiliarRanking->AdvancedSearch->SearchOperator2 = @$filter["w_auxiliarRanking"];
        $this->auxiliarRanking->AdvancedSearch->save();
    ...
    protected function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->actual;
        $searchFlds[] = &$this->next;
        $searchFlds[] = &$this->description;
        $searchFlds[] = &$this->instructorName;
        $searchFlds[] = &$this->instructorLastName;
        $searchFlds[] = &$this->auxiliarName;
        $searchFlds[] = &$this->auxiliarLastName;
        $searchFlds[] = &$this->city;
        $searchFlds[] = &$this->uf;
        $searchFlds[] = &$this->instructorRanking;
        $searchFlds[] = &$this->auxiliarRanking;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->testId); // testId
            $this->updateSort($this->memberId); // memberId
            $this->updateSort($this->name); // name
            $this->updateSort($this->lastName); // lastName
            $this->updateSort($this->actual); // actual
            $this->updateSort($this->next); // next
            $this->updateSort($this->memberAge); // memberAge
            $this->updateSort($this->memberDOB); // memberDOB
            $this->updateSort($this->description); // description
            $this->updateSort($this->instructorName); // instructorName
            $this->updateSort($this->instructorLastName); // instructorLastName
            $this->updateSort($this->auxiliarName); // auxiliarName
            $this->updateSort($this->auxiliarLastName); // auxiliarLastName
            ...
            $this->updateSort($this->uf); // uf
            $this->updateSort($this->instructorRanking); // instructorRanking
            $this->updateSort($this->auxiliarRanking); // auxiliarRanking
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->instructorName->setSort("");
                $this->instructorLastName->setSort("");
                $this->auxiliarName->setSort("");
                $this->auxiliarLastName->setSort("");
                $this->testDate->setSort("");
                $this->testTime->setSort("");
                $this->ceremonyDate->setSort("");
                $this->city->setSort("");
                $this->uf->setSort("");
                $this->instructorRanking->setSort("");
                $this->auxiliarRanking->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fview_certificate_datalist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fview_certificate_datalist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->testId->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("testId", $this->createColumnOption("testId"));
            ...
            $option->add("next", $this->createColumnOption("next"));
            $option->add("memberAge", $this->createColumnOption("memberAge"));
            $option->add("memberDOB", $this->createColumnOption("memberDOB"));
            $option->add("description", $this->createColumnOption("description"));
            $option->add("instructorName", $this->createColumnOption("instructorName"));
            $option->add("instructorLastName", $this->createColumnOption("instructorLastName"));
            $option->add("auxiliarName", $this->createColumnOption("auxiliarName"));
            $option->add("auxiliarLastName", $this->createColumnOption("auxiliarLastName"));
            ...
            $option->add("uf", $this->createColumnOption("uf"));
            $option->add("instructorRanking", $this->createColumnOption("instructorRanking"));
            $option->add("auxiliarRanking", $this->createColumnOption("auxiliarRanking"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fview_certificate_datasrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fview_certificate_datasrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fview_certificate_datalist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    protected function newRow()
    {
        ...
        $row['next'] = $this->next->DefaultValue;
        $row['memberAge'] = $this->memberAge->DefaultValue;
        $row['memberDOB'] = $this->memberDOB->DefaultValue;
        $row['description'] = $this->description->DefaultValue;
        $row['instructorName'] = $this->instructorName->DefaultValue;
        $row['instructorLastName'] = $this->instructorLastName->DefaultValue;
        $row['auxiliarName'] = $this->auxiliarName->DefaultValue;
        $row['auxiliarLastName'] = $this->auxiliarLastName->DefaultValue;
        ...
        $row['instructorRanking'] = $this->instructorRanking->DefaultValue;
        $row['auxiliarRanking'] = $this->auxiliarRanking->DefaultValue;
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fview_certificate_datasrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
