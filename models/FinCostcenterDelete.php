 ...
 * Page class
 */
class FinCostcenterDelete extends FinCostcenter
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinCostcenterDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FinCostcenterList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("FinCostcenterList"); // Return to list
            return;
        }
