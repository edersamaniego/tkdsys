 ...
 * Page class
 */
class FedLicenseschoolPreview extends FedLicenseschool
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedLicenseschoolPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "fed_applicationschool") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=fed_applicationschool&" . GetForeignKeyUrl("fk_id", $this->application->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeysFromFilter($f)
    {
        ...
        if ($masterTblVar == "fed_applicationschool") {
            ...
            if ($x !== false) {
                ...
                $this->application->setQueryStringValue($val);
            }
        }
    }
