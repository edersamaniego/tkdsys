 ...
 * Page class
 */
class SchoolUsersView extends SchoolUsers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SchoolUsersView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "SchoolUsersList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("SchoolUsersList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "SchoolUsersList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "SchoolUsersList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
