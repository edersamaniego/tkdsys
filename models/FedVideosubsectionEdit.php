 ...
 * Page class
 */
class FedVideosubsectionEdit extends FedVideosubsection
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedVideosubsectionEdit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("FedVideosubsectionList"); // Return to list page
                        return;
    ...
    protected function validateForm()
    {
        ...
        if (in_array("fed_video", $detailTblVar) && $detailPage->DetailEdit) {
