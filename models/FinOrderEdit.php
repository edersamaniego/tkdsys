 ...
 * Page class
 */
class FinOrderEdit extends FinOrder
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinOrderEdit";
    ...
    protected function validateForm()
    {
        ...
        if (in_array("fin_orderdetails", $detailTblVar) && $detailPage->DetailEdit) {
    ...
    protected function editRow()
    {
        ...
        // debtor
        $this->debtor->setDbValueDef($rsnew, $this->debtor->CurrentValue, null, $this->debtor->ReadOnly);
