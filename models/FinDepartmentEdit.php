 ...
 * Page class
 */
class FinDepartmentEdit extends FinDepartment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinDepartmentEdit";
    ...
    public function run()
    {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("FinDepartmentList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "FinDepartmentList") {
