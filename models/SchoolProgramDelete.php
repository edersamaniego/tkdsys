 ...
 * Page class
 */
class SchoolProgramDelete extends SchoolProgram
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SchoolProgramDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SchoolProgramList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("SchoolProgramList"); // Return to list
            return;
        }
