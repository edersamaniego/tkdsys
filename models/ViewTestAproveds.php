...
class ViewTestAproveds extends DbTable
{
    ...
    public function __construct()
    {
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->memberId->Lookup = new Lookup('memberId', 'school_member', false, 'id', ["name","lastName","",""], [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`name`, ''),'" . ValueSeparator(1, $this->memberId) . "',COALESCE(`lastName`,''))");
                break;
            case "pt-BR":
                $this->memberId->Lookup = new Lookup('memberId', 'school_member', false, 'id', ["name","lastName","",""], [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`name`, ''),'" . ValueSeparator(1, $this->memberId) . "',COALESCE(`lastName`,''))");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->rankId->Lookup = new Lookup('rankId', 'fed_rank', false, 'id', ["rankBR","","",""], [], [], [], [], [], [], '', '', "`rankBR`");
                break;
            case "pt-BR":
                $this->rankId->Lookup = new Lookup('rankId', 'fed_rank', false, 'id', ["rankBR","","",""], [], [], [], [], [], [], '', '', "`rankBR`");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->schoolId->Lookup = new Lookup('schoolId', 'fed_school', false, 'id', ["school","countryId","cityId",""], [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`school`, ''),'" . ValueSeparator(1, $this->schoolId) . "',COALESCE(`countryId`,''),'" . ValueSeparator(2, $this->schoolId) . "',COALESCE(`cityId`,''))");
                break;
            case "pt-BR":
                $this->schoolId->Lookup = new Lookup('schoolId', 'fed_school', false, 'id', ["school","countryId","cityId",""], [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`school`, ''),'" . ValueSeparator(1, $this->schoolId) . "',COALESCE(`countryId`,''),'" . ValueSeparator(2, $this->schoolId) . "',COALESCE(`cityId`,''))");
                break;
