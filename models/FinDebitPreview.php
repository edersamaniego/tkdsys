 ...
 * Page class
 */
class FinDebitPreview extends FinDebit
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinDebitPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "fin_accountspayable") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=fin_accountspayable&" . GetForeignKeyUrl("fk_id", $this->accountId->QueryStringValue) . "";
        }
