 ...
 * Page class
 */
class FinDiscountDelete extends FinDiscount
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinDiscountDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FinDiscountList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("FinDiscountList"); // Return to list
            return;
        }
