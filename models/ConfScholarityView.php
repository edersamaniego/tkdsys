 ...
 * Page class
 */
class ConfScholarityView extends ConfScholarity
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConfScholarityView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ConfScholarityList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "ConfScholarityList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "ConfScholarityList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
