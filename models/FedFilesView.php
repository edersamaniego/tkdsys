 ...
 * Page class
 */
class FedFilesView extends FedFiles
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedFilesView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FedFilesList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("FedFilesList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "FedFilesList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "FedFilesList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
