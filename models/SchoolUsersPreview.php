 ...
 * Page class
 */
class SchoolUsersPreview extends SchoolUsers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SchoolUsersPreview";
    ...
    protected function setupSortOrder()
    {
        ...
        if (SameText(Get("cmd"), "resetsort")) {
            ...
            $this->schoolIdMaster->setSort("");
            $this->schoolId->setSort("");
            $this->_login->setSort("");
            $this->_email->setSort("");
            $this->activateEmail->setSort("");
            $this->profileField->setSort("");
        ...
        if ($this->CurrentOrder !== "") {
            ...
            $this->updateSort($this->schoolIdMaster); // schoolIdMaster
            $this->updateSort($this->schoolId); // schoolId
            $this->updateSort($this->_login); // login
            $this->updateSort($this->_email); // email
            $this->updateSort($this->activateEmail); // activateEmail
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "fed_school") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=fed_school&" . GetForeignKeyUrl("fk_id", $this->schoolId->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeysFromFilter($f)
    {
        ...
        if ($masterTblVar == "fed_school") {
            ...
            if ($x !== false) {
                ...
                $this->schoolId->setQueryStringValue($val);
            }
        }
    }
