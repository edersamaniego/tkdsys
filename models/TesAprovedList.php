 ...
 * Page class
 */
class TesAprovedList extends TesAproved
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TesAprovedList";
    ...
    public $FormName = "ftes_aprovedlist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "TesAprovedAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "TesAprovedDelete";
        $this->MultiUpdateUrl = "TesAprovedUpdate";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "ftes_aprovedsrch");
        }
        $filterList = Concat($filterList, $this->id->AdvancedSearch->toJson(), ","); // Field id
        $filterList = Concat($filterList, $this->resultAmountId->AdvancedSearch->toJson(), ","); // Field resultAmountId
        ...
        $filterList = Concat($filterList, $this->memberName->AdvancedSearch->toJson(), ","); // Field memberName
        ...
        $filterList = Concat($filterList, $this->newRankId->AdvancedSearch->toJson(), ","); // Field newRankId
        $filterList = Concat($filterList, $this->oldRankId->AdvancedSearch->toJson(), ","); // Field oldRankId
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "ftes_aprovedsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field resultAmountId
        $this->resultAmountId->AdvancedSearch->SearchValue = @$filter["x_resultAmountId"];
        $this->resultAmountId->AdvancedSearch->SearchOperator = @$filter["z_resultAmountId"];
        $this->resultAmountId->AdvancedSearch->SearchCondition = @$filter["v_resultAmountId"];
        $this->resultAmountId->AdvancedSearch->SearchValue2 = @$filter["y_resultAmountId"];
        $this->resultAmountId->AdvancedSearch->SearchOperator2 = @$filter["w_resultAmountId"];
        $this->resultAmountId->AdvancedSearch->save();
        ...
        // Field memberName
        $this->memberName->AdvancedSearch->SearchValue = @$filter["x_memberName"];
        $this->memberName->AdvancedSearch->SearchOperator = @$filter["z_memberName"];
        $this->memberName->AdvancedSearch->SearchCondition = @$filter["v_memberName"];
        $this->memberName->AdvancedSearch->SearchValue2 = @$filter["y_memberName"];
        $this->memberName->AdvancedSearch->SearchOperator2 = @$filter["w_memberName"];
        $this->memberName->AdvancedSearch->save();
        ...
        // Field newRankId
        $this->newRankId->AdvancedSearch->SearchValue = @$filter["x_newRankId"];
        $this->newRankId->AdvancedSearch->SearchOperator = @$filter["z_newRankId"];
        $this->newRankId->AdvancedSearch->SearchCondition = @$filter["v_newRankId"];
        $this->newRankId->AdvancedSearch->SearchValue2 = @$filter["y_newRankId"];
        $this->newRankId->AdvancedSearch->SearchOperator2 = @$filter["w_newRankId"];
        $this->newRankId->AdvancedSearch->save();

        // Field oldRankId
        $this->oldRankId->AdvancedSearch->SearchValue = @$filter["x_oldRankId"];
        $this->oldRankId->AdvancedSearch->SearchOperator = @$filter["z_oldRankId"];
        $this->oldRankId->AdvancedSearch->SearchCondition = @$filter["v_oldRankId"];
        $this->oldRankId->AdvancedSearch->SearchValue2 = @$filter["y_oldRankId"];
        $this->oldRankId->AdvancedSearch->SearchOperator2 = @$filter["w_oldRankId"];
        $this->oldRankId->AdvancedSearch->save();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->resultAmountId); // resultAmountId
            $this->updateSort($this->federationId); // federationId
            $this->updateSort($this->schoolId); // schoolId
            $this->updateSort($this->testId); // testId
            $this->updateSort($this->memberId); // memberId
            $this->updateSort($this->memberName); // memberName
            $this->updateSort($this->createUserId); // createUserId
            $this->updateSort($this->createDate); // createDate
            $this->updateSort($this->newRankId); // newRankId
            $this->updateSort($this->oldRankId); // oldRankId
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"ftes_aprovedlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"ftes_aprovedlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("resultAmountId", $this->createColumnOption("resultAmountId"));
            $option->add("federationId", $this->createColumnOption("federationId"));
            ...
            $option->add("memberName", $this->createColumnOption("memberName"));
            $option->add("createUserId", $this->createColumnOption("createUserId"));
            $option->add("createDate", $this->createColumnOption("createDate"));
            $option->add("newRankId", $this->createColumnOption("newRankId"));
            $option->add("oldRankId", $this->createColumnOption("oldRankId"));
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"ftes_aprovedsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"ftes_aprovedsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="ftes_aprovedlist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="ftes_aprovedlist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"ftes_aprovedsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
