 ...
 * Page class
 */
class FedRankPreview extends FedRank
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedRankPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "fed_martialarts") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=fed_martialarts&" . GetForeignKeyUrl("fk_id", $this->martialArtsId->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeysFromFilter($f)
    {
        ...
        if ($masterTblVar == "fed_martialarts") {
            ...
            if ($x !== false) {
                ...
                $this->martialArtsId->setQueryStringValue($val);
            }
        }
    }
