 ...
 * Page class
 */
class FedRankAdd extends FedRank
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        $this->id->Visible = false;
        $this->rankBR->Visible = false;
        $this->rankUS->Visible = false;
        $this->rankES->Visible = false;
        $this->ranking->Visible = false;
        $this->nextrankId->Visible = false;
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("FedRankList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "FedRankList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "FedRankView") {
