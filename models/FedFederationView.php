 ...
 * Page class
 */
class FedFederationView extends FedFederation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedFederationView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FedFederationList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "FedFederationList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "FedFederationList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
