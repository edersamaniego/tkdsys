 ...
 * Page class
 */
class ConfMembertypeView extends ConfMembertype
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConfMembertypeView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ConfMembertypeList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "ConfMembertypeList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "ConfMembertypeList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
