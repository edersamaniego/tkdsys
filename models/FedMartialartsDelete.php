 ...
 * Page class
 */
class FedMartialartsDelete extends FedMartialarts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedMartialartsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FedMartialartsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("FedMartialartsList"); // Return to list
                return;
            }
        }
