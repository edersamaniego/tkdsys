 ...
 * Page class
 */
class FinDepartmentView extends FinDepartment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinDepartmentView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FinDepartmentList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("FinDepartmentList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "FinDepartmentList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "FinDepartmentList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("FinDepartmentList"), "", $this->TableVar, true);
        $pageId = "view";
