 ...
 * Page class
 */
class TesResultamountAdd extends TesResultamount
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TesResultamountAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "TesResultamountView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // sendingDate
        $this->sendingDate->setDbValueDef($rsnew, UnFormatDateTime($this->sendingDate->CurrentValue, $this->sendingDate->formatPattern()), null, false);
        ...
        // printingDate
        $this->printingDate->setDbValueDef($rsnew, UnFormatDateTime($this->printingDate->CurrentValue, $this->printingDate->formatPattern()), null, false);

        // shippedDate
        $this->shippedDate->setDbValueDef($rsnew, UnFormatDateTime($this->shippedDate->CurrentValue, $this->shippedDate->formatPattern()), null, false);
        ...
        // paymentId
        $this->paymentId->setDbValueDef($rsnew, $this->paymentId->CurrentValue, null, false);

        // totalValue
        $this->totalValue->setDbValueDef($rsnew, $this->totalValue->CurrentValue, null, false);
