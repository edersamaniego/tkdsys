 ...
 * Page class
 */
class TesResultamountDelete extends TesResultamount
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TesResultamountDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TesResultamountList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("TesResultamountList"); // Return to list
            return;
        }
