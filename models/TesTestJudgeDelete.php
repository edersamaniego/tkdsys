 ...
 * Page class
 */
class TesTestJudgeDelete extends TesTestJudge
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TesTestJudgeDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TesTestJudgeList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("TesTestJudgeList"); // Return to list
                return;
            }
        }
