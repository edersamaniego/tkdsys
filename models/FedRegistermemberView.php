 ...
 * Page class
 */
class FedRegistermemberView extends FedRegistermember
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedRegistermemberView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FedRegistermemberList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "FedRegistermemberList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "FedRegistermemberList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
