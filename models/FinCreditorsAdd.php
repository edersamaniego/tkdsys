 ...
 * Page class
 */
class FinCreditorsAdd extends FinCreditors
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinCreditorsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "FinCreditorsView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // creditor
        $this->creditor->setDbValueDef($rsnew, $this->creditor->CurrentValue, null, false);

        // uniqueCode
        $this->uniqueCode->setDbValueDef($rsnew, $this->uniqueCode->CurrentValue, null, false);

        // IDcode
        $this->IDcode->setDbValueDef($rsnew, $this->IDcode->CurrentValue, null, false);

        // adress
        $this->adress->setDbValueDef($rsnew, $this->adress->CurrentValue, null, false);
        ...
        // telephone1
        $this->telephone1->setDbValueDef($rsnew, $this->telephone1->CurrentValue, null, false);

        // telephone2
        $this->telephone2->setDbValueDef($rsnew, $this->telephone2->CurrentValue, null, false);
