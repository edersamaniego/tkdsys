...
/**
 * Table class for view_news
 */
class ViewNews extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_news';
        $this->TableName = 'view_news';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_news`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->id->Lookup = new Lookup('id', 'conf_news', false, 'id', ["descriptionEN","","",""], [], [], [], [], [], [], '', '', "`descriptionEN`");
                break;
            case "pt-BR":
                $this->id->Lookup = new Lookup('id', 'conf_news', false, 'id', ["descriptionBR","","",""], [], [], [], [], [], [], '', '', "`descriptionBR`");
                break;
            case "es":
                $this->id->Lookup = new Lookup('id', 'conf_news', false, 'id', ["descriptionSP","","",""], [], [], [], [], [], [], '', '', "`descriptionSP`");
                break;
            default:
                $this->id->Lookup = new Lookup('id', 'conf_news', false, 'id', ["descriptionEN","","",""], [], [], [], [], [], [], '', '', "`descriptionEN`");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_news`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewNewsList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewNewsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewNewsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewNewsAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewNewsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewNewsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewNewsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewNewsAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ViewNewsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewNewsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewNewsDelete", $this->getUrlParm());
    }
