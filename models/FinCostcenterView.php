 ...
 * Page class
 */
class FinCostcenterView extends FinCostcenter
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinCostcenterView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FinCostcenterList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "FinCostcenterList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "FinCostcenterList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
