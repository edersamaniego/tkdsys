 ...
 * Page class
 */
class SchoolModalityView extends SchoolModality
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SchoolModalityView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "SchoolModalityList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "SchoolModalityList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "SchoolModalityList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
