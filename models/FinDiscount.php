...
/**
 * Table class for fin_discount
 */
class FinDiscount extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'fin_discount';
        $this->TableName = 'fin_discount';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`fin_discount`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->type->Lookup = new Lookup('type', 'fin_discount', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
            case "pt-BR":
                $this->type->Lookup = new Lookup('type', 'fin_discount', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`fin_discount`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("FinDiscountList");
    }
    ...
    {
        global $Language;
        if ($pageName == "FinDiscountView") {
            return $Language->phrase("View");
        } elseif ($pageName == "FinDiscountEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "FinDiscountAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "FinDiscountView";
            case Config("API_ADD_ACTION"):
                return "FinDiscountAdd";
            case Config("API_EDIT_ACTION"):
                return "FinDiscountEdit";
            case Config("API_DELETE_ACTION"):
                return "FinDiscountDelete";
            case Config("API_LIST_ACTION"):
                return "FinDiscountList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("FinDiscountView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("FinDiscountView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "FinDiscountAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "FinDiscountAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("FinDiscountEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FinDiscountAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("FinDiscountDelete", $this->getUrlParm());
    }
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM `fin_discount`";
