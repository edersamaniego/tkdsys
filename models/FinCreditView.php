 ...
 * Page class
 */
class FinCreditView extends FinCredit
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinCreditView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FinCreditList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("FinCreditList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "FinCreditList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "FinCreditList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
