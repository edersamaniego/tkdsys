 ...
 * Page class
 */
class FinOrderdetailsView extends FinOrderdetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinOrderdetailsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FinOrderdetailsList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "FinOrderdetailsList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "FinOrderdetailsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
