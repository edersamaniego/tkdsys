 ...
 * Page class
 */
class FinTypeView extends FinType
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinTypeView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FinTypeList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("FinTypeList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "FinTypeList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "FinTypeList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
