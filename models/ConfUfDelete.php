 ...
 * Page class
 */
class ConfUfDelete extends ConfUf
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConfUfDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ConfUfList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ConfUfList"); // Return to list
                return;
            }
        }
