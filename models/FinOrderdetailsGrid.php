 ...
 * Page class
 */
class FinOrderdetailsGrid extends FinOrderdetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinOrderdetailsGrid";
    ...
    public $FormName = "ffin_orderdetailsgrid";
    ...
    public function emptyRow()
    {
        ...
        if (
            ...
            !($this->orderId->IsForeignKey && $this->getCurrentMasterTable() != "" &&
        ...
        if (
            ...
            !($this->item->IsForeignKey && $this->getCurrentMasterTable() != "" &&
            $this->item->CurrentValue == $this->item->getSessionValue())
        ) {
            return false;
        }
        if (
            ...
            !($this->amount->IsForeignKey && $this->getCurrentMasterTable() != "" &&
            $this->amount->CurrentValue == $this->amount->getSessionValue())
        ) {
            return false;
        }
        if (
        ...
        if (
            $CurrentForm->hasValue("x_discountId") &&
            $CurrentForm->hasValue("o_discountId") &&
            $this->discountId->CurrentValue != $this->discountId->DefaultValue &&
            !($this->discountId->IsForeignKey && $this->getCurrentMasterTable() != "" &&
            $this->discountId->CurrentValue == $this->discountId->getSessionValue())
        ) {
            return false;
        }
        return true;
    ...
    public function resetFormError()
    {
        ...
        $this->item->clearErrorMessage();
        $this->amount->clearErrorMessage();
        $this->value->clearErrorMessage();
        $this->discountId->clearErrorMessage();
    }
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_discountId")) {
            $this->discountId->setOldValue($CurrentForm->getValue("o_discountId"));
        }
    }
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->orderId->getSessionValue() != "") {
                ...
                if (strval($this->orderId->EditValue) != "" && is_numeric($this->orderId->EditValue)) {
                    ...
                    $this->orderId->OldValue = $this->orderId->EditValue;
                }
            }
            ...
            if (strval($this->item->EditValue) != "" && is_numeric($this->item->EditValue)) {
                ...
                $this->item->OldValue = $this->item->EditValue;
            }
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($Security->currentUserID() != "" && !$Security->isAdmin()) { // Non system admin
            ...
            $masterTable = Container("fin_order");
            ...
            if (!EmptyValue($masterFilter)) {
                ...
                } elseif ($this->getCurrentMasterTable() == "fin_order") {
