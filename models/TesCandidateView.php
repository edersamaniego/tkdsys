 ...
 * Page class
 */
class TesCandidateView extends TesCandidate
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TesCandidateView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "TesCandidateList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("TesCandidateList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "TesCandidateList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "TesCandidateList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("TesCandidateList"), "", $this->TableVar, true);
        $pageId = "view";
