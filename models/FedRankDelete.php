 ...
 * Page class
 */
class FedRankDelete extends FedRank
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedRankDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FedRankList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("FedRankList"); // Return to list
                return;
            }
        }
