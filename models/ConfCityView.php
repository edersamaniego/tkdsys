 ...
 * Page class
 */
class ConfCityView extends ConfCity
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConfCityView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ConfCityList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("ConfCityList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "ConfCityList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "ConfCityList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
