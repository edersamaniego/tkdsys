 ...
 * Page class
 */
class ConfCountryView extends ConfCountry
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConfCountryView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ConfCountryList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "ConfCountryList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "ConfCountryList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
