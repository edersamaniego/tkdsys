 ...
 * Page class
 */
class SchoolUsersDelete extends SchoolUsers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SchoolUsersDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SchoolUsersList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("SchoolUsersList"); // Return to list
            return;
        }
