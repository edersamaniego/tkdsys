 ...
 * Page class
 */
class FedRankView extends FedRank
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedRankView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FedRankList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "FedRankList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "FedRankList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
