 ...
 * Page class
 */
class ConfTestestatusView extends ConfTestestatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConfTestestatusView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ConfTestestatusList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("ConfTestestatusList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "ConfTestestatusList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "ConfTestestatusList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
