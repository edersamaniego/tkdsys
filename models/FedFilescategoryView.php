 ...
 * Page class
 */
class FedFilescategoryView extends FedFilescategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedFilescategoryView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FedFilescategoryList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "FedFilescategoryList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "FedFilescategoryList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
