 ...
 * Page class
 */
class SchoolModalityDelete extends SchoolModality
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SchoolModalityDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SchoolModalityList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("SchoolModalityList"); // Return to list
            return;
        }
