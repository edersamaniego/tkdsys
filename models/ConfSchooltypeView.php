 ...
 * Page class
 */
class ConfSchooltypeView extends ConfSchooltype
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConfSchooltypeView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ConfSchooltypeList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "ConfSchooltypeList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "ConfSchooltypeList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
