 ...
 * Page class
 */
class FinCreditorsDelete extends FinCreditors
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinCreditorsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FinCreditorsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("FinCreditorsList"); // Return to list
            return;
        }
