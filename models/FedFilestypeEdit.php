 ...
 * Page class
 */
class FedFilestypeEdit extends FedFilestype
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedFilestypeEdit";
    ...
    public function run()
    {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("FedFilestypeList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "FedFilestypeList") {
