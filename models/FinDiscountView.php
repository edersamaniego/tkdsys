 ...
 * Page class
 */
class FinDiscountView extends FinDiscount
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinDiscountView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FinDiscountList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("FinDiscountList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "FinDiscountList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "FinDiscountList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("FinDiscountList"), "", $this->TableVar, true);
        $pageId = "view";
