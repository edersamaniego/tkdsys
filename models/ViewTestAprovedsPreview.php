 ...
 * Page class
 */
class ViewTestAprovedsPreview extends ViewTestAproveds
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewTestAprovedsPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "tes_test") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=tes_test&" . GetForeignKeyUrl("fk_id", $this->testId->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeysFromFilter($f)
    {
        ...
        if ($masterTblVar == "tes_test") {
            ...
            if ($x !== false) {
                ...
                $this->testId->setQueryStringValue($val);
            }
        }
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewTestAprovedsList"), "", $this->TableVar, true);
        $pageId = "preview";
