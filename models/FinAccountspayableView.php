 ...
 * Page class
 */
class FinAccountspayableView extends FinAccountspayable
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinAccountspayableView";
    ...
    public function run()
    {
        ...
        $this->firstInstallmentDate->setVisibility();
        ...
        $this->incomeReceivable->setVisibility();
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FinAccountspayableList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "FinAccountspayableList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "FinAccountspayableList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupOtherOptions()
    {
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("FinDebitList?" . Config("TABLE_SHOW_MASTER") . "=fin_accountspayable&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("FinDebitGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'fin_accountspayable')) {
        ...
        if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'fin_accountspayable')) {
        ...
        if ($detailPageObj->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'fin_accountspayable')) {
