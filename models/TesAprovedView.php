 ...
 * Page class
 */
class TesAprovedView extends TesAproved
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TesAprovedView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "TesAprovedList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "TesAprovedList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "TesAprovedList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
