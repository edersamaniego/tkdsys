 ...
 * Page class
 */
class FinCreditAdd extends FinCredit
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinCreditAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("FinCreditList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "FinCreditList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "FinCreditView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // accountId
        $this->accountId->setDbValueDef($rsnew, $this->accountId->CurrentValue, null, false);
        ...
        if ($Security->currentUserID() != "" && !$Security->isAdmin()) { // Non system admin
            ...
            if (!EmptyValue($masterFilter)) {
                ...
                } elseif ($this->getCurrentMasterTable() == "fin_accountsreceivable") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("FinCreditList"), "", $this->TableVar, true);
