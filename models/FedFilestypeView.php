 ...
 * Page class
 */
class FedFilestypeView extends FedFilestype
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedFilestypeView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FedFilestypeList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("FedFilestypeList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "FedFilestypeList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "FedFilestypeList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("FedFilestypeList"), "", $this->TableVar, true);
        $pageId = "view";
