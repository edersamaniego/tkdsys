 ...
 * Page class
 */
class SchoolClassDelete extends SchoolClass
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SchoolClassDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SchoolClassList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("SchoolClassList"); // Return to list
            return;
        }
