...
/**
 * Table class for conf_uf
 */
class ConfUf extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'conf_uf';
        $this->TableName = 'conf_uf';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`conf_uf`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->abbreviation->InputTextType = "text";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`conf_uf`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ConfUfList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "ConfUfEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ConfUfAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ConfUfView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ConfUfView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ConfUfAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ConfUfAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ConfUfEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ConfUfAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ConfUfDelete", $this->getUrlParm());
    }
