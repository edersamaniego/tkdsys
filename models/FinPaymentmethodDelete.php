 ...
 * Page class
 */
class FinPaymentmethodDelete extends FinPaymentmethod
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinPaymentmethodDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FinPaymentmethodList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("FinPaymentmethodList"); // Return to list
            return;
        }
