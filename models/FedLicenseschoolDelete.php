 ...
 * Page class
 */
class FedLicenseschoolDelete extends FedLicenseschool
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedLicenseschoolDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FedLicenseschoolList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("FedLicenseschoolList"); // Return to list
                return;
            }
        }
