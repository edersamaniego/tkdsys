 ...
 * Page class
 */
class FinCostcenterAdd extends FinCostcenter
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinCostcenterAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "FinCostcenterView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // costCenter
        $this->costCenter->setDbValueDef($rsnew, $this->costCenter->CurrentValue, null, false);
