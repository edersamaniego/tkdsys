 ...
 * Page class
 */
class SchoolUsersAdd extends SchoolUsers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SchoolUsersAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("SchoolUsersList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "SchoolUsersList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "SchoolUsersView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // profileField
        $this->profileField->setDbValueDef($rsnew, $this->profileField->CurrentValue, null, false);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("SchoolUsersList"), "", $this->TableVar, true);
