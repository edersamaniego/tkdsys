 ...
 * Page class
 */
class FinEmployeeDelete extends FinEmployee
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinEmployeeDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FinEmployeeList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("FinEmployeeList"); // Return to list
            return;
        }
