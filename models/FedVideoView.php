 ...
 * Page class
 */
class FedVideoView extends FedVideo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedVideoView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FedVideoList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "FedVideoList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "FedVideoList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
