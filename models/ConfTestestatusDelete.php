 ...
 * Page class
 */
class ConfTestestatusDelete extends ConfTestestatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConfTestestatusDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ConfTestestatusList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ConfTestestatusList"); // Return to list
                return;
            }
        }
