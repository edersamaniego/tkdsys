 ...
 * Page class
 */
class FinCreditPreview extends FinCredit
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinCreditPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "fin_accountsreceivable") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=fin_accountsreceivable&" . GetForeignKeyUrl("fk_id", $this->accountId->QueryStringValue) . "";
        }
        if ($masterTblVar == "fin_checkingaccount") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=fin_checkingaccount&" . GetForeignKeyUrl("fk_id", $this->accountId->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeysFromFilter($f)
    {
        ...
        if ($masterTblVar == "fin_accountsreceivable") {
            ...
            if ($x !== false) {
                ...
                $this->accountId->setQueryStringValue($val);
            }
        }
        if ($masterTblVar == "fin_checkingaccount") {
            $find = "`accountId`=";
