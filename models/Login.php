 ...
 * Page class
 */
class Login extends SchoolUsers
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        $this->Username = new DbField("school_users", "school_users", "username", "username", "username", "", 202, 255, -1, false, "", false, false, false);
        $this->Username->EditAttrs->appendClass("form-control ew-form-control");
        $this->Password = new DbField("school_users", "school_users", "password", "password", "password", "", 202, 255, -1, false, "", false, false, false);
        $this->Password->EditAttrs->appendClass("form-control ew-form-control");
        if (Config("ENCRYPTED_PASSWORD")) {
            $this->Password->Raw = true;
        }
        $this->LoginType = new DbField("school_users", "school_users", "type", "logintype", "logintype", "", 202, 255, -1, false, "", false, false, false);
    ...
    public function pageRedirecting(&$url)
    {
        // Example:
        //$url = "your URL";
        if(CurrentUserLevel() == 5){ // caso o usuário for do nível aplicação
        	$url = "FedApplicationschoolList";
        }
    }
