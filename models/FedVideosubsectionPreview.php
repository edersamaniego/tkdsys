 ...
 * Page class
 */
class FedVideosubsectionPreview extends FedVideosubsection
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedVideosubsectionPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "fed_videosection") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=fed_videosection&" . GetForeignKeyUrl("fk_id", $this->section->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeysFromFilter($f)
    {
        ...
        if ($masterTblVar == "fed_videosection") {
            ...
            if ($x !== false) {
                ...
                $this->section->setQueryStringValue($val);
            }
        }
    }
