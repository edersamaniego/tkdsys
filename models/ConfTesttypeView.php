 ...
 * Page class
 */
class ConfTesttypeView extends ConfTesttype
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConfTesttypeView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ConfTesttypeList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "ConfTesttypeList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "ConfTesttypeList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
