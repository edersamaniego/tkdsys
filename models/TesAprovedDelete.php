 ...
 * Page class
 */
class TesAprovedDelete extends TesAproved
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TesAprovedDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TesAprovedList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("TesAprovedList"); // Return to list
            return;
        }
