...
/**
 * Table class for fed_judgelevel
 */
class FedJudgelevel extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'fed_judgelevel';
        $this->TableName = 'fed_judgelevel';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`fed_judgelevel`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->judgeLevel->InputTextType = "text";
        $this->Fields['judgeLevel'] = &$this->judgeLevel;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`fed_judgelevel`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->judgeLevel->DbValue = $row['judgeLevel'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("FedJudgelevelList");
    }
    ...
    {
        global $Language;
        if ($pageName == "FedJudgelevelView") {
            return $Language->phrase("View");
        } elseif ($pageName == "FedJudgelevelEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "FedJudgelevelAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "FedJudgelevelView";
            case Config("API_ADD_ACTION"):
                return "FedJudgelevelAdd";
            case Config("API_EDIT_ACTION"):
                return "FedJudgelevelEdit";
            case Config("API_DELETE_ACTION"):
                return "FedJudgelevelDelete";
            case Config("API_LIST_ACTION"):
                return "FedJudgelevelList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("FedJudgelevelView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("FedJudgelevelView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "FedJudgelevelAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "FedJudgelevelAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FedJudgelevelEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FedJudgelevelAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("FedJudgelevelDelete", $this->getUrlParm());
    }
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->judgeLevel->setDbValue($row['judgeLevel']);
    ...
    public function renderListRow()
    {
        ...
        // judgeLevel
        $this->judgeLevel->ViewValue = $this->judgeLevel->CurrentValue;
        $this->judgeLevel->ViewCustomAttributes = "";
        ...
        // judgeLevel
        $this->judgeLevel->LinkCustomAttributes = "";
        $this->judgeLevel->HrefValue = "";
        $this->judgeLevel->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->federationId->Raw) {
            $this->federationId->CurrentValue = HtmlDecode($this->federationId->CurrentValue);
        }
        ...
        // judgeLevel
        $this->judgeLevel->setupEditAttributes();
        $this->judgeLevel->EditCustomAttributes = "";
        if (!$this->judgeLevel->Raw) {
            $this->judgeLevel->CurrentValue = HtmlDecode($this->judgeLevel->CurrentValue);
        }
        $this->judgeLevel->EditValue = $this->judgeLevel->CurrentValue;
        $this->judgeLevel->PlaceHolder = RemoveHtml($this->judgeLevel->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->judgeLevel);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->judgeLevel);
