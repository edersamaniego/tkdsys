 ...
 * Page class
 */
class ConfNewsView extends ConfNews
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConfNewsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ConfNewsList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "ConfNewsList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "ConfNewsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
