 ...
 * Page class
 */
class ConfMemberstatusEdit extends ConfMemberstatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConfMemberstatusEdit";
    ...
    public function run()
    {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ConfMemberstatusList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "ConfMemberstatusList") {
    ...
    protected function editRow()
    {
        ...
        // statusES
        $this->statusES->setDbValueDef($rsnew, $this->statusES->CurrentValue, null, $this->statusES->ReadOnly);

        // statusEN
        $this->statusEN->setDbValueDef($rsnew, $this->statusEN->CurrentValue, null, $this->statusEN->ReadOnly);
