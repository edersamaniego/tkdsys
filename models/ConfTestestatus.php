...
/**
 * Table class for conf_testestatus
 */
class ConfTestestatus extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'conf_testestatus';
        $this->TableName = 'conf_testestatus';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`conf_testestatus`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->testStatus->InputTextType = "text";
        $this->Fields['testStatus'] = &$this->testStatus;

        // statusEN
        $this->statusEN = new DbField(
            'conf_testestatus',
            'conf_testestatus',
            'x_statusEN',
            'statusEN',
        ...
        $this->statusEN->InputTextType = "text";
        $this->Fields['statusEN'] = &$this->statusEN;

        // statusES
        $this->statusES = new DbField(
            'conf_testestatus',
            'conf_testestatus',
            'x_statusES',
            'statusES',
        ...
        $this->statusES->InputTextType = "text";
        $this->Fields['statusES'] = &$this->statusES;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`conf_testestatus`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->testStatus->DbValue = $row['testStatus'];
        $this->statusEN->DbValue = $row['statusEN'];
        $this->statusES->DbValue = $row['statusES'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ConfTestestatusList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "ConfTestestatusEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ConfTestestatusAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ConfTestestatusView";
            case Config("API_ADD_ACTION"):
                return "ConfTestestatusAdd";
            case Config("API_EDIT_ACTION"):
                return "ConfTestestatusEdit";
            case Config("API_DELETE_ACTION"):
                return "ConfTestestatusDelete";
            case Config("API_LIST_ACTION"):
                return "ConfTestestatusList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ConfTestestatusView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ConfTestestatusView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ConfTestestatusAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ConfTestestatusAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ConfTestestatusEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ConfTestestatusAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ConfTestestatusDelete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->testStatus->EditValue = $this->testStatus->CurrentValue;
        ...
        $this->statusEN->EditValue = $this->statusEN->CurrentValue;
        ...
        $this->statusES->EditValue = $this->statusES->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->testStatus);
                    $doc->exportCaption($this->statusEN);
                    $doc->exportCaption($this->statusES);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->testStatus);
                        $doc->exportField($this->statusEN);
                        $doc->exportField($this->statusES);
