 ...
 * Page class
 */
class ConfMemberstatusView extends ConfMemberstatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConfMemberstatusView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ConfMemberstatusList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("ConfMemberstatusList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "ConfMemberstatusList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "ConfMemberstatusList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ConfMemberstatusList"), "", $this->TableVar, true);
        $pageId = "view";
