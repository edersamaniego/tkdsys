 ...
 * Page class
 */
class FinDiscountEdit extends FinDiscount
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinDiscountEdit";
    ...
    public function run()
    {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("FinDiscountList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "FinDiscountList") {
