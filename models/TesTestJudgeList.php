 ...
 * Page class
 */
class TesTestJudgeList extends TesTestJudge
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TesTestJudgeList";
    ...
    public $FormName = "ftes_test_judgelist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "TesTestJudgeAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "TesTestJudgeDelete";
        $this->MultiUpdateUrl = "TesTestJudgeUpdate";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "ftes_test_judgesrch");
        }
        $filterList = Concat($filterList, $this->id->AdvancedSearch->toJson(), ","); // Field id
        $filterList = Concat($filterList, $this->judgeMemberId->AdvancedSearch->toJson(), ","); // Field judgeMemberId
        ...
        $filterList = Concat($filterList, $this->instructorRegister->AdvancedSearch->toJson(), ","); // Field instructorRegister
        $filterList = Concat($filterList, $this->federationRegister->AdvancedSearch->toJson(), ","); // Field federationRegister
        $filterList = Concat($filterList, $this->memberCityId->AdvancedSearch->toJson(), ","); // Field memberCityId
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "ftes_test_judgesrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field judgeMemberId
        $this->judgeMemberId->AdvancedSearch->SearchValue = @$filter["x_judgeMemberId"];
        $this->judgeMemberId->AdvancedSearch->SearchOperator = @$filter["z_judgeMemberId"];
        $this->judgeMemberId->AdvancedSearch->SearchCondition = @$filter["v_judgeMemberId"];
        $this->judgeMemberId->AdvancedSearch->SearchValue2 = @$filter["y_judgeMemberId"];
        $this->judgeMemberId->AdvancedSearch->SearchOperator2 = @$filter["w_judgeMemberId"];
        $this->judgeMemberId->AdvancedSearch->save();
        ...
        // Field instructorRegister
        $this->instructorRegister->AdvancedSearch->SearchValue = @$filter["x_instructorRegister"];
        $this->instructorRegister->AdvancedSearch->SearchOperator = @$filter["z_instructorRegister"];
        $this->instructorRegister->AdvancedSearch->SearchCondition = @$filter["v_instructorRegister"];
        $this->instructorRegister->AdvancedSearch->SearchValue2 = @$filter["y_instructorRegister"];
        $this->instructorRegister->AdvancedSearch->SearchOperator2 = @$filter["w_instructorRegister"];
        $this->instructorRegister->AdvancedSearch->save();
        ...
        // Field memberCityId
        $this->memberCityId->AdvancedSearch->SearchValue = @$filter["x_memberCityId"];
        $this->memberCityId->AdvancedSearch->SearchOperator = @$filter["z_memberCityId"];
        $this->memberCityId->AdvancedSearch->SearchCondition = @$filter["v_memberCityId"];
        $this->memberCityId->AdvancedSearch->SearchValue2 = @$filter["y_memberCityId"];
        $this->memberCityId->AdvancedSearch->SearchOperator2 = @$filter["w_memberCityId"];
        $this->memberCityId->AdvancedSearch->save();
    ...
    protected function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->instructorRegister;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->judgeMemberId); // judgeMemberId
            $this->updateSort($this->testId); // testId
            $this->updateSort($this->rankId); // rankId
            $this->updateSort($this->instructorRegister); // instructorRegister
            $this->updateSort($this->federationRegister); // federationRegister
            $this->updateSort($this->memberCityId); // memberCityId
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->id->setSort("");
                $this->judgeMemberId->setSort("");
                $this->testId->setSort("");
                $this->rankId->setSort("");
                $this->instructorRegister->setSort("");
                $this->federationRegister->setSort("");
                $this->memberCityId->setSort("");
            }
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"ftes_test_judgelist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"ftes_test_judgelist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("judgeMemberId", $this->createColumnOption("judgeMemberId"));
            $option->add("testId", $this->createColumnOption("testId"));
            $option->add("rankId", $this->createColumnOption("rankId"));
            $option->add("instructorRegister", $this->createColumnOption("instructorRegister"));
            $option->add("federationRegister", $this->createColumnOption("federationRegister"));
            $option->add("memberCityId", $this->createColumnOption("memberCityId"));
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"ftes_test_judgesrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"ftes_test_judgesrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="ftes_test_judgelist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->judgeMemberId->TooltipValue = "";
            ...
            $this->instructorRegister->TooltipValue = "";
            ...
            $this->memberCityId->TooltipValue = "";
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="ftes_test_judgelist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"ftes_test_judgesrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
