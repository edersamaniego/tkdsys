 ...
 * Page class
 */
class FinTypeDelete extends FinType
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinTypeDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FinTypeList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("FinTypeList"); // Return to list
            return;
        }
