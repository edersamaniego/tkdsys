 ...
 * Page class
 */
class ConfUfEdit extends ConfUf
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ConfUfList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "ConfUfList") {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->countryId->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->countryId->setFormValue($val, true, $validate);
            }
        }
    }
    ...
    public function renderRow()
    {
        ...
        // abbreviation
        $this->abbreviation->RowCssClass = "row";
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // abbreviation
            $this->abbreviation->setupEditAttributes();
            ...
            $this->countryId->EditValue = HtmlEncode($this->countryId->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if (!CheckInteger($this->countryId->FormValue)) {
            $this->countryId->addErrorMessage($this->countryId->getErrorMessage(false));
        }
