 ...
 * Page class
 */
class FedRegistermemberAdd extends FedRegistermember
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedRegistermemberAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "FedRegistermemberView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // currentRankId
        $this->currentRankId->setDbValueDef($rsnew, $this->currentRankId->CurrentValue, null, false);

        // obs
        $this->obs->setDbValueDef($rsnew, $this->obs->CurrentValue, null, false);

        // registerType
        $this->registerType->setDbValueDef($rsnew, $this->registerType->CurrentValue, null, false);
