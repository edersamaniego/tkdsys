 ...
 * Page class
 */
class TesResultamountView extends TesResultamount
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TesResultamountView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "TesResultamountList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "TesResultamountList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "TesResultamountList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
