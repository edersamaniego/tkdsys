 ...
 * Page class
 */
class FinOrderDelete extends FinOrder
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinOrderDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FinOrderList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("FinOrderList"); // Return to list
            return;
        }
