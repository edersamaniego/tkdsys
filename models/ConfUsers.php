...
/**
 * Table class for conf_users
 */
class ConfUsers extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'conf_users';
        $this->TableName = 'conf_users';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`conf_users`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`conf_users`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ConfUsersList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ConfUsersView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ConfUsersEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ConfUsersAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ConfUsersView";
            case Config("API_ADD_ACTION"):
                return "ConfUsersAdd";
            case Config("API_EDIT_ACTION"):
                return "ConfUsersEdit";
            case Config("API_DELETE_ACTION"):
                return "ConfUsersDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ConfUsersView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ConfUsersView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ConfUsersAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ConfUsersAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ConfUsersEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ConfUsersAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ConfUsersDelete", $this->getUrlParm());
    }
    ...
    public function renderListRow()
    {
        ...
        $this->level->ViewValue = FormatNumber($this->level->ViewValue, $this->level->formatPattern());
