 ...
 * Page class
 */
class TesTestJudgeView extends TesTestJudge
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TesTestJudgeView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "TesTestJudgeList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("TesTestJudgeList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "TesTestJudgeList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "TesTestJudgeList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
