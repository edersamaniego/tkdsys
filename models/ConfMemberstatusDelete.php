 ...
 * Page class
 */
class ConfMemberstatusDelete extends ConfMemberstatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConfMemberstatusDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ConfMemberstatusList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ConfMemberstatusList"); // Return to list
                return;
            }
        }
