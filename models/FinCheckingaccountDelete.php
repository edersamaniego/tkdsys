 ...
 * Page class
 */
class FinCheckingaccountDelete extends FinCheckingaccount
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinCheckingaccountDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FinCheckingaccountList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("FinCheckingaccountList"); // Return to list
            return;
        }
