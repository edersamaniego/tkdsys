 ...
 * Page class
 */
class FinCreditorsView extends FinCreditors
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinCreditorsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FinCreditorsList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "FinCreditorsList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "FinCreditorsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
