 ...
 * Page class
 */
class ChangePassword extends SchoolUsers
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        $this->OldPassword = new DbField("school_users", "school_users", "opwd", "opwd", "opwd", "", 202, 255, -1, false, "", false, false, false);
        $this->OldPassword->EditAttrs->appendClass("form-control ew-form-control");
        $this->NewPassword = new DbField("school_users", "school_users", "npwd", "npwd", "npwd", "", 202, 255, -1, false, "", false, false, false);
        $this->NewPassword->EditAttrs->appendClass("form-control ew-form-control");
        $this->ConfirmPassword = new DbField("school_users", "school_users", "cpwd", "cpwd", "cpwd", "", 202, 255, -1, false, "", false, false, false);
