 ...
 * Page class
 */
class FedRegistermemberDelete extends FedRegistermember
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedRegistermemberDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FedRegistermemberList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("FedRegistermemberList"); // Return to list
                return;
            }
        }
