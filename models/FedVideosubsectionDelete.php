 ...
 * Page class
 */
class FedVideosubsectionDelete extends FedVideosubsection
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedVideosubsectionDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FedVideosubsectionList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("FedVideosubsectionList"); // Return to list
                return;
            }
        }
