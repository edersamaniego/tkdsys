...
/**
 * Table class for fin_orderdetails
 */
class FinOrderdetails extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'fin_orderdetails';
        $this->TableName = 'fin_orderdetails';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`fin_orderdetails`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    public function getMasterFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "fin_order") {
            if ($this->orderId->getSessionValue() != "") {
                $masterFilter .= "" . GetForeignKeySql("`id`", $this->orderId->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getMasterFilter($masterTable, $keys)
    {
        ...
        switch ($masterTable->TableVar) {
            case "fin_order":
                ...
                if ($validKeys) {
                    return "`id`=" . QuotedValue($keys["orderId"], $masterTable->id->DataType, $masterTable->Dbid);
                }
                break;
        }
    ...
    public function getDetailFilter($masterTable)
    {
        switch ($masterTable->TableVar) {
            case "fin_order":
                return "`orderId`=" . QuotedValue($masterTable->id->DbValue, $this->orderId->DataType, $this->Dbid);
        }
        return "";
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`fin_orderdetails`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("FinOrderdetailsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "FinOrderdetailsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "FinOrderdetailsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "FinOrderdetailsView";
            case Config("API_ADD_ACTION"):
                return "FinOrderdetailsAdd";
            case Config("API_EDIT_ACTION"):
                return "FinOrderdetailsEdit";
            case Config("API_DELETE_ACTION"):
                return "FinOrderdetailsDelete";
            case Config("API_LIST_ACTION"):
                return "FinOrderdetailsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("FinOrderdetailsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("FinOrderdetailsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "FinOrderdetailsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "FinOrderdetailsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FinOrderdetailsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FinOrderdetailsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("FinOrderdetailsDelete", $this->getUrlParm());
    }

    // Add master url
    public function addMasterUrl($url)
    {
        if ($this->getCurrentMasterTable() == "fin_order" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->orderId->CurrentValue);
        }
        return $url;
    }
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM `fin_orderdetails`";
    ...
    {
        $filterWrk = $filter;
        if ($currentMasterTable == "fin_order") {
            $filterWrk = Container("fin_order")->addUserIDFilter($filterWrk);
        }
        return $filterWrk;
    }
    ...
    public function addDetailUserIDFilter($filter, $currentMasterTable)
    {
        ...
        if ($currentMasterTable == "fin_order") {
            ...
            if (!$mastertable->userIDAllow()) {
                $subqueryWrk = $mastertable->getUserIDSubquery($this->orderId, $mastertable->id);
