...
/**
 * Table class for conf_city
 */
class ConfCity extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'conf_city';
        $this->TableName = 'conf_city';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`conf_city`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->uf->Lookup = new Lookup('uf', 'conf_uf', false, 'id', ["abbreviation","","",""], ["x_ufId"], [], ["id"], ["x_id"], [], [], '', '', "`abbreviation`");
                break;
            case "pt-BR":
                $this->uf->Lookup = new Lookup('uf', 'conf_uf', false, 'id', ["abbreviation","","",""], ["x_ufId"], [], ["id"], ["x_id"], [], [], '', '', "`abbreviation`");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->ufId->Lookup = new Lookup('ufId', 'conf_uf', false, 'id', ["UF","","",""], [], ["x_uf"], [], [], [], [], '', '', "`UF`");
                break;
            case "pt-BR":
                $this->ufId->Lookup = new Lookup('ufId', 'conf_uf', false, 'id', ["UF","","",""], [], ["x_uf"], [], [], [], [], '', '', "`UF`");
                break;
        ...
        $this->county->InputTextType = "text";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`conf_city`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ConfCityList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ConfCityView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ConfCityEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ConfCityAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ConfCityView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ConfCityView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ConfCityAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ConfCityAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ConfCityEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ConfCityAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ConfCityDelete", $this->getUrlParm());
    }
