 ...
 * Page class
 */
class FinOrderdetailsDelete extends FinOrderdetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinOrderdetailsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FinOrderdetailsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("FinOrderdetailsList"); // Return to list
            return;
        }
