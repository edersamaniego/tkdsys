 ...
 * Page class
 */
class FinOrderdetailsPreview extends FinOrderdetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinOrderdetailsPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "fin_order") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=fin_order&" . GetForeignKeyUrl("fk_id", $this->orderId->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeysFromFilter($f)
    {
        ...
        if ($masterTblVar == "fin_order") {
            ...
            if ($x !== false) {
                ...
                $this->orderId->setQueryStringValue($val);
            }
        }
    }
