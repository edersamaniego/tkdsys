 ...
 * Page class
 */
class FedVideoPreview extends FedVideo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedVideoPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "fed_videosubsection") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=fed_videosubsection&" . GetForeignKeyUrl("fk_id", $this->subsection->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeysFromFilter($f)
    {
        ...
        if ($masterTblVar == "fed_videosubsection") {
            ...
            if ($x !== false) {
                ...
                $val = substr($f, $x);
                $val = $this->unquoteValue($val, "DB");
                $this->subsection->setQueryStringValue($val);
            }
        }
    }
