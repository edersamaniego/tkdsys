...
/**
 * Table class for tes_candidate
 */
class TesCandidate extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'tes_candidate';
        $this->TableName = 'tes_candidate';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`tes_candidate`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->memberId->Lookup = new Lookup('memberId', 'school_member', false, 'id', ["name","lastName","",""], [], [], [], [], ["birthdate","rankId","age"], ["x_memberDOB","x_rankId","x_memberAge"], '', '', "CONCAT(COALESCE(`name`, ''),'" . ValueSeparator(1, $this->memberId) . "',COALESCE(`lastName`,''))");
                break;
            case "pt-BR":
                $this->memberId->Lookup = new Lookup('memberId', 'school_member', false, 'id', ["name","lastName","",""], [], [], [], [], ["birthdate","rankId","age"], ["x_memberDOB","x_rankId","x_memberAge"], '', '', "CONCAT(COALESCE(`name`, ''),'" . ValueSeparator(1, $this->memberId) . "',COALESCE(`lastName`,''))");
                break;
        ...
        $this->rankId->Required = true; // Required field
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->rankId->Lookup = new Lookup('rankId', 'fed_rank', false, 'id', ["rankUS","","",""], [], [], [], [], ["nextrankId"], ["x_nextRankId"], '', '', "`rankUS`");
                break;
            case "pt-BR":
                $this->rankId->Lookup = new Lookup('rankId', 'fed_rank', false, 'id', ["rankUS","","",""], [], [], [], [], ["nextrankId"], ["x_nextRankId"], '', '', "`rankUS`");
                break;
        ...
        // testNominated
        $this->testNominated = new DbField(
            'tes_candidate',
            'tes_candidate',
            'x_testNominated',
            'testNominated',
        ...
        $this->testNominated->InputTextType = "text";
        $this->testNominated->DataType = DATATYPE_BOOLEAN;
        switch ($CurrentLanguage) {
            case "en-US":
                $this->testNominated->Lookup = new Lookup('testNominated', 'tes_candidate', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
            case "pt-BR":
                $this->testNominated->Lookup = new Lookup('testNominated', 'tes_candidate', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        $this->testPaid->InputTextType = "text";
        $this->testPaid->DataType = DATATYPE_BOOLEAN;
        switch ($CurrentLanguage) {
            case "en-US":
                $this->testPaid->Lookup = new Lookup('testPaid', 'tes_candidate', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
            case "pt-BR":
                $this->testPaid->Lookup = new Lookup('testPaid', 'tes_candidate', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->testId->Lookup = new Lookup('testId', 'tes_test', false, 'id', ["description","testCity","testDate","testTime"], [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`description`, ''),'" . ValueSeparator(1, $this->testId) . "',COALESCE(`testCity`,''),'" . ValueSeparator(2, $this->testId) . "',COALESCE(" . CastDateFieldForLike("`testDate`", 0, "DB") . ",''),'" . ValueSeparator(3, $this->testId) . "',COALESCE(" . CastDateFieldForLike("`testTime`", 4, "DB") . ",''))");
                break;
            case "pt-BR":
                $this->testId->Lookup = new Lookup('testId', 'tes_test', false, 'id', ["description","testCity","testDate","testTime"], [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`description`, ''),'" . ValueSeparator(1, $this->testId) . "',COALESCE(`testCity`,''),'" . ValueSeparator(2, $this->testId) . "',COALESCE(" . CastDateFieldForLike("`testDate`", 0, "DB") . ",''),'" . ValueSeparator(3, $this->testId) . "',COALESCE(" . CastDateFieldForLike("`testTime`", 4, "DB") . ",''))");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->result->Lookup = new Lookup('result', 'tes_candidate', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
            case "pt-BR":
                $this->result->Lookup = new Lookup('result', 'tes_candidate', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        $this->nextRankId->Required = true; // Required field
        ...
        $this->renew->InputTextType = "text";
        $this->renew->DataType = DATATYPE_BOOLEAN;
        switch ($CurrentLanguage) {
            case "en-US":
                $this->renew->Lookup = new Lookup('renew', 'tes_candidate', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
            case "pt-BR":
                $this->renew->Lookup = new Lookup('renew', 'tes_candidate', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->createUseriD->Lookup = new Lookup('createUseriD', 'school_member', false, 'id', ["name","lastName","",""], [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`name`, ''),'" . ValueSeparator(1, $this->createUseriD) . "',COALESCE(`lastName`,''))");
                break;
            case "pt-BR":
                $this->createUseriD->Lookup = new Lookup('createUseriD', 'school_member', false, 'id', ["name","lastName","",""], [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`name`, ''),'" . ValueSeparator(1, $this->createUseriD) . "',COALESCE(`lastName`,''))");
                break;
    ...
    public function getMasterFilter($masterTable, $keys)
    {
        ...
        switch ($masterTable->TableVar) {
            case "tes_test":
                ...
                if ($validKeys) {
                    return "`id`=" . QuotedValue($keys["testId"], $masterTable->id->DataType, $masterTable->Dbid);
                }
                break;
        }
    ...
    public function getDetailFilter($masterTable)
    {
        switch ($masterTable->TableVar) {
            case "tes_test":
                return "`testId`=" . QuotedValue($masterTable->id->DbValue, $this->testId->DataType, $this->Dbid);
        }
        return "";
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`tes_candidate`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TesCandidateList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TesCandidateView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TesCandidateEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TesCandidateAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TesCandidateView";
            case Config("API_ADD_ACTION"):
                return "TesCandidateAdd";
            case Config("API_EDIT_ACTION"):
                return "TesCandidateEdit";
            case Config("API_DELETE_ACTION"):
                return "TesCandidateDelete";
            case Config("API_LIST_ACTION"):
                return "TesCandidateList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TesCandidateView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TesCandidateView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TesCandidateAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "TesCandidateAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("TesCandidateEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TesCandidateAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TesCandidateDelete", $this->getUrlParm());
    }
    ...
    public function addMasterUrl($url)
    {
        if ($this->getCurrentMasterTable() == "tes_test" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            ...
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->testId->CurrentValue);
        }
        return $url;
    }
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM `tes_candidate`";
