 ...
 * Page class
 */
class FinPaymentmethodEdit extends FinPaymentmethod
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinPaymentmethodEdit";
    ...
    public function run()
    {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("FinPaymentmethodList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "FinPaymentmethodList") {
