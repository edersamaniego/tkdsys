...
/**
 * Table class for fin_paymentmethod
 */
class FinPaymentmethod extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'fin_paymentmethod';
        $this->TableName = 'fin_paymentmethod';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`fin_paymentmethod`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->_default->Lookup = new Lookup('default', 'fin_paymentmethod', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
            case "pt-BR":
                $this->_default->Lookup = new Lookup('default', 'fin_paymentmethod', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`fin_paymentmethod`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("FinPaymentmethodList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "FinPaymentmethodEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "FinPaymentmethodAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "FinPaymentmethodView";
            case Config("API_ADD_ACTION"):
                return "FinPaymentmethodAdd";
            case Config("API_EDIT_ACTION"):
                return "FinPaymentmethodEdit";
            case Config("API_DELETE_ACTION"):
                return "FinPaymentmethodDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("FinPaymentmethodView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("FinPaymentmethodView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "FinPaymentmethodAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "FinPaymentmethodAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FinPaymentmethodEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FinPaymentmethodAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("FinPaymentmethodDelete", $this->getUrlParm());
    }
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM `fin_paymentmethod`";
