 ...
 * Page class
 */
class FinEmployeeView extends FinEmployee
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinEmployeeView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FinEmployeeList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "FinEmployeeList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "FinEmployeeList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
