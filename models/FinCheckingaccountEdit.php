 ...
 * Page class
 */
class FinCheckingaccountEdit extends FinCheckingaccount
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinCheckingaccountEdit";
    ...
    protected function editRow()
    {
        ...
        // bank
        $this->bank->setDbValueDef($rsnew, $this->bank->CurrentValue, null, $this->bank->ReadOnly);
