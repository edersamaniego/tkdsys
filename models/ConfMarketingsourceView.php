 ...
 * Page class
 */
class ConfMarketingsourceView extends ConfMarketingsource
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConfMarketingsourceView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ConfMarketingsourceList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "ConfMarketingsourceList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "ConfMarketingsourceList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
