 ...
 * Page class
 */
class FedFilesDelete extends FedFiles
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedFilesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FedFilesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("FedFilesList"); // Return to list
                return;
            }
        }
