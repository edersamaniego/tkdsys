 ...
 * Page class
 */
class FinDepartmentDelete extends FinDepartment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinDepartmentDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FinDepartmentList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("FinDepartmentList"); // Return to list
            return;
        }
