 ...
 * Page class
 */
class FedSchoolPreview extends FedSchool
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedSchoolPreview";
    ...
    protected function previewSql($filter)
    {
        ...
        if (ContainsString(" " . $sort . " ", " " . $this->cityId->VirtualExpression . " ")) {
            $useVirtual = true;
        }
        if ($useVirtual) {
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "fed_applicationschool") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=fed_applicationschool&" . GetForeignKeyUrl("fk_id", $this->applicationId->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeysFromFilter($f)
    {
        ...
        if ($masterTblVar == "fed_applicationschool") {
            ...
            if ($x !== false) {
                ...
                $this->applicationId->setQueryStringValue($val);
            }
        }
    }
