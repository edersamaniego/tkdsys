 ...
 * Page class
 */
class FedFilescategoryAdd extends FedFilescategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedFilescategoryAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "FedFilescategoryView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // categoryBr
        $this->categoryBr->setDbValueDef($rsnew, $this->categoryBr->CurrentValue, null, false);

        // categorySp
        $this->categorySp->setDbValueDef($rsnew, $this->categorySp->CurrentValue, null, false);
