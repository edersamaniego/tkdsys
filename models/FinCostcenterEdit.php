 ...
 * Page class
 */
class FinCostcenterEdit extends FinCostcenter
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FinCostcenterEdit";
    ...
    public function run()
    {
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("FinCostcenterList"); // Return to list page
                        return;
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("FinCostcenterList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "FinCostcenterList") {
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'costCenter' first before field var 'x_costCenter'
        $val = $CurrentForm->hasValue("costCenter") ? $CurrentForm->getValue("costCenter") : $CurrentForm->getValue("x_costCenter");
        if (!$this->costCenter->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->costCenter->Visible = false; // Disable update for API request
            } else {
                $this->costCenter->setFormValue($val);
            }
        }
        ...
        if (!$this->organization->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->organization->Visible = false; // Disable update for API request
            } else {
                $this->organization->setFormValue($val);
            }
        }
    }
    ...
    public function restoreFormValues()
    {
        ...
        $this->costCenter->CurrentValue = $this->costCenter->FormValue;
    ...
    public function renderRow()
    {
        ...
        // costCenter
        $this->costCenter->RowCssClass = "row";
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // costCenter
            $this->costCenter->setupEditAttributes();
            $this->costCenter->EditCustomAttributes = "";
            if (!$this->costCenter->Raw) {
                $this->costCenter->CurrentValue = HtmlDecode($this->costCenter->CurrentValue);
            }
            $this->costCenter->EditValue = HtmlEncode($this->costCenter->CurrentValue);
            $this->costCenter->PlaceHolder = RemoveHtml($this->costCenter->caption());
    ...
    protected function validateForm()
    {
        ...
        if ($this->costCenter->Required) {
            if (!$this->costCenter->IsDetailKey && EmptyValue($this->costCenter->FormValue)) {
                $this->costCenter->addErrorMessage(str_replace("%s", $this->costCenter->caption(), $this->costCenter->RequiredErrorMessage));
            }
        }
    ...
    protected function editRow()
    {
        ...
        // costCenter
        $this->costCenter->setDbValueDef($rsnew, $this->costCenter->CurrentValue, null, $this->costCenter->ReadOnly);
        ...
        // organization
        $this->organization->CurrentValue = CurrentOrganizationID();
        $this->organization->setDbValueDef($rsnew, $this->organization->CurrentValue, null);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("FinCostcenterList"), "", $this->TableVar, true);
        $pageId = "edit";
