 ...
 * Page class
 */
class FedVideoDelete extends FedVideo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FedVideoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FedVideoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("FedVideoList"); // Return to list
                return;
            }
        }
