 ...
 * Page class
 */
class SchoolClassView extends SchoolClass
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SchoolClassView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "SchoolClassList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "SchoolClassList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "SchoolClassList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
