 ...
 * Page class
 */
class SchoolProgramView extends SchoolProgram
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SchoolProgramView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "SchoolProgramList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("SchoolProgramList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "SchoolProgramList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "SchoolProgramList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
