 ...
 * Page class
 */
class SchoolUsersList extends SchoolUsers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SchoolUsersList";
    ...
    public $FormName = "fschool_userslist";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "SchoolUsersDelete";
        $this->MultiUpdateUrl = "SchoolUsersUpdate";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fschool_userssrch");
        }
        ...
        $filterList = Concat($filterList, $this->schoolIdMaster->AdvancedSearch->toJson(), ","); // Field schoolIdMaster
        ...
        $filterList = Concat($filterList, $this->activateEmail->AdvancedSearch->toJson(), ","); // Field activateEmail
        $filterList = Concat($filterList, $this->profileField->AdvancedSearch->toJson(), ","); // Field profileField
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fschool_userssrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field schoolIdMaster
        $this->schoolIdMaster->AdvancedSearch->SearchValue = @$filter["x_schoolIdMaster"];
        $this->schoolIdMaster->AdvancedSearch->SearchOperator = @$filter["z_schoolIdMaster"];
        $this->schoolIdMaster->AdvancedSearch->SearchCondition = @$filter["v_schoolIdMaster"];
        $this->schoolIdMaster->AdvancedSearch->SearchValue2 = @$filter["y_schoolIdMaster"];
        $this->schoolIdMaster->AdvancedSearch->SearchOperator2 = @$filter["w_schoolIdMaster"];
        $this->schoolIdMaster->AdvancedSearch->save();
        ...
        // Field activateEmail
        $this->activateEmail->AdvancedSearch->SearchValue = @$filter["x_activateEmail"];
        $this->activateEmail->AdvancedSearch->SearchOperator = @$filter["z_activateEmail"];
        $this->activateEmail->AdvancedSearch->SearchCondition = @$filter["v_activateEmail"];
        $this->activateEmail->AdvancedSearch->SearchValue2 = @$filter["y_activateEmail"];
        $this->activateEmail->AdvancedSearch->SearchOperator2 = @$filter["w_activateEmail"];
        $this->activateEmail->AdvancedSearch->save();

        // Field profileField
        $this->profileField->AdvancedSearch->SearchValue = @$filter["x_profileField"];
        $this->profileField->AdvancedSearch->SearchOperator = @$filter["z_profileField"];
        $this->profileField->AdvancedSearch->SearchCondition = @$filter["v_profileField"];
        $this->profileField->AdvancedSearch->SearchValue2 = @$filter["y_profileField"];
        $this->profileField->AdvancedSearch->SearchOperator2 = @$filter["w_profileField"];
        $this->profileField->AdvancedSearch->save();
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fschool_userslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fschool_userslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("schoolIdMaster", $this->createColumnOption("schoolIdMaster"));
            $option->add("schoolId", $this->createColumnOption("schoolId"));
            $option->add("login", $this->createColumnOption("login"));
            $option->add("email", $this->createColumnOption("email"));
            $option->add("activateEmail", $this->createColumnOption("activateEmail"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fschool_userssrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fschool_userssrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fschool_userslist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fschool_userssrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
