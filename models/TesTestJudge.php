...
/**
 * Table class for tes_test_judge
 */
class TesTestJudge extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'tes_test_judge';
        $this->TableName = 'tes_test_judge';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`tes_test_judge`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // judgeMemberId
        $this->judgeMemberId = new DbField(
            'tes_test_judge',
            'tes_test_judge',
            'x_judgeMemberId',
            'judgeMemberId',
        ...
        $this->judgeMemberId->InputTextType = "text";
        $this->judgeMemberId->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['judgeMemberId'] = &$this->judgeMemberId;
        ...
        // instructorRegister
        $this->instructorRegister = new DbField(
            'tes_test_judge',
            'tes_test_judge',
            'x_instructorRegister',
            'instructorRegister',
            '`instructorRegister`',
            '`instructorRegister`',
            200,
        ...
        $this->instructorRegister->InputTextType = "text";
        $this->Fields['instructorRegister'] = &$this->instructorRegister;
        ...
        $this->memberCityId->InputTextType = "text";
        $this->memberCityId->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['memberCityId'] = &$this->memberCityId;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`tes_test_judge`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->judgeMemberId->DbValue = $row['judgeMemberId'];
        $this->testId->DbValue = $row['testId'];
        $this->rankId->DbValue = $row['rankId'];
        $this->instructorRegister->DbValue = $row['instructorRegister'];
        $this->federationRegister->DbValue = $row['federationRegister'];
        $this->memberCityId->DbValue = $row['memberCityId'];
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TesTestJudgeList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "TesTestJudgeEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TesTestJudgeAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TesTestJudgeView";
            case Config("API_ADD_ACTION"):
                return "TesTestJudgeAdd";
            case Config("API_EDIT_ACTION"):
                return "TesTestJudgeEdit";
            case Config("API_DELETE_ACTION"):
                return "TesTestJudgeDelete";
            case Config("API_LIST_ACTION"):
                return "TesTestJudgeList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TesTestJudgeView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TesTestJudgeView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TesTestJudgeAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "TesTestJudgeAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("TesTestJudgeEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TesTestJudgeAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TesTestJudgeDelete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->judgeMemberId->EditValue = $this->judgeMemberId->CurrentValue;
        ...
        $this->instructorRegister->EditValue = $this->instructorRegister->CurrentValue;
        ...
        $this->memberCityId->EditValue = $this->memberCityId->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->judgeMemberId);
                    $doc->exportCaption($this->testId);
                    $doc->exportCaption($this->rankId);
                    $doc->exportCaption($this->instructorRegister);
                    $doc->exportCaption($this->federationRegister);
                    $doc->exportCaption($this->memberCityId);
                } else {
                    $doc->exportCaption($this->id);
                    $doc->exportCaption($this->judgeMemberId);
                    $doc->exportCaption($this->testId);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->judgeMemberId);
                        $doc->exportField($this->testId);
                        $doc->exportField($this->rankId);
                        $doc->exportField($this->instructorRegister);
                        $doc->exportField($this->federationRegister);
                        $doc->exportField($this->memberCityId);
                    } else {
                        $doc->exportField($this->id);
                        $doc->exportField($this->judgeMemberId);
                        $doc->exportField($this->testId);
