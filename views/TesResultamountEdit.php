...
// Page object
$TesResultamountEdit = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { tes_resultamount: currentTable } });
var currentForm, currentPageID;
var ftes_resultamountedit;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    ftes_resultamountedit = new ew.Form("ftes_resultamountedit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = ftes_resultamountedit;

    // Add fields
    var fields = currentTable.fields;
    ftes_resultamountedit.addFields([
    ...
    // Form_CustomValidate
    ftes_resultamountedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ftes_resultamountedit.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("ftes_resultamountedit");
});
</script>
<script>
...
<?php } ?>
<form name="ftes_resultamountedit" id="ftes_resultamountedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id"<?= $Page->id->rowAttributes() ?>>
        <label id="elh_tes_resultamount_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->id->cellAttributes() ?>>
<span id="el_tes_resultamount_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
<input type="hidden" data-table="tes_resultamount" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<span id="el_tes_resultamount_schoolId">
    <select
        ...
        data-select2-id="ftes_resultamountedit_x_schoolId"
...
<script>
loadjs.ready("ftes_resultamountedit", function() {
    var options = { name: "x_schoolId", selectId: "ftes_resultamountedit_x_schoolId" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ftes_resultamountedit.lists.schoolId.lookupOptions.length) {
        options.data = { id: "x_schoolId", form: "ftes_resultamountedit" };
    } else {
        options.ajax = { id: "x_schoolId", form: "ftes_resultamountedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<script>
loadjs.ready(["ftes_resultamountedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ftes_resultamountedit", "x_sendingDate", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["ftes_resultamountedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ftes_resultamountedit", "x_paymentDate", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["ftes_resultamountedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ftes_resultamountedit", "x_printingDate", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["ftes_resultamountedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ftes_resultamountedit", "x_shippedDate", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["ftes_resultamountedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ftes_resultamountedit", "x_createDate", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
