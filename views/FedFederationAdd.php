...
// Page object
$FedFederationAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { fed_federation: currentTable } });
var currentForm, currentPageID;
var ffed_federationadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    ffed_federationadd = new ew.Form("ffed_federationadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = ffed_federationadd;

    // Add fields
    var fields = currentTable.fields;
    ffed_federationadd.addFields([
    ...
    // Form_CustomValidate
    ffed_federationadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ffed_federationadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("ffed_federationadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="ffed_federationadd" id="ffed_federationadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["ffed_federationadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ffed_federationadd", "x_createDate", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
