...
ew.ready("head", [ew.PATH_BASE + "timepicker/jquery.timepicker.min.js", ew.PATH_BASE + "js/ewtimepicker.min.js"], "timepicker");
</script>
<!-- Navbar -->
        ...
        <div class="container-fluid">
            ...
            <ul id="ew-navbar" class="navbar-nav">
                ...
                <a class="navbar-brand d-none" href="#" data-ew-action="none">
                    <img src="<?= GetUrl("images/SCHOOL.png") ?>" alt="" class="brand-image ew-brand-image">
                </a>
            </ul>
            <!-- Right navbar links -->
