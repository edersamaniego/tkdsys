...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    ffin_orderadd = new ew.Form("ffin_orderadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = ffin_orderadd;

    // Add fields
    var fields = currentTable.fields;
    ffin_orderadd.addFields([
    ...
    // Form_CustomValidate
    ffin_orderadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ffin_orderadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    ffin_orderadd.lists.discountId = <?= $Page->discountId->toClientList($Page) ?>;
    loadjs.done("ffin_orderadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="ffin_orderadd" id="ffin_orderadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready("ffin_orderadd", function() {
    ffin_orderadd.createAutoSuggest(Object.assign({"id":"x_discountId","forceSelect":false}, ew.vars.tables.fin_order.fields.discountId.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["ffin_orderadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ffin_orderadd", "x_date", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["ffin_orderadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ffin_orderadd", "x_due", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<?php
    if (in_array("fin_orderdetails", explode(",", $Page->getCurrentDetailTable())) && $fin_orderdetails->DetailAdd) {
?>
