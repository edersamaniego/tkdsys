...
// Page object
$SchoolMemberEdit = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { school_member: currentTable } });
var currentForm, currentPageID;
var fschool_memberedit;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fschool_memberedit = new ew.Form("fschool_memberedit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = fschool_memberedit;

    // Add fields
    var fields = currentTable.fields;
    fschool_memberedit.addFields([
    ...
    // Form_CustomValidate
    fschool_memberedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fschool_memberedit.validateRequired = ew.CLIENT_VALIDATE;

    // Multi-Page
    fschool_memberedit.multiPage = new ew.MultiPage("fschool_memberedit");

    // Dynamic selection lists
    fschool_memberedit.lists.gender = <?= $Page->gender->toClientList($Page) ?>;
    fschool_memberedit.lists.countryId = <?= $Page->countryId->toClientList($Page) ?>;
    fschool_memberedit.lists.UFId = <?= $Page->UFId->toClientList($Page) ?>;
    fschool_memberedit.lists.cityId = <?= $Page->cityId->toClientList($Page) ?>;
    fschool_memberedit.lists.receiveSmsFather = <?= $Page->receiveSmsFather->toClientList($Page) ?>;
    fschool_memberedit.lists.receiveEmailFather = <?= $Page->receiveEmailFather->toClientList($Page) ?>;
    fschool_memberedit.lists.receiveSmsMother = <?= $Page->receiveSmsMother->toClientList($Page) ?>;
    fschool_memberedit.lists.receiveEmailMother = <?= $Page->receiveEmailMother->toClientList($Page) ?>;
    fschool_memberedit.lists.modalityId = <?= $Page->modalityId->toClientList($Page) ?>;
    fschool_memberedit.lists.instructorStatus = <?= $Page->instructorStatus->toClientList($Page) ?>;
    fschool_memberedit.lists.martialArtId = <?= $Page->martialArtId->toClientList($Page) ?>;
    fschool_memberedit.lists.rankId = <?= $Page->rankId->toClientList($Page) ?>;
    fschool_memberedit.lists.schoolId = <?= $Page->schoolId->toClientList($Page) ?>;
    fschool_memberedit.lists.memberStatusId = <?= $Page->memberStatusId->toClientList($Page) ?>;
    fschool_memberedit.lists.memberLevelId = <?= $Page->memberLevelId->toClientList($Page) ?>;
    fschool_memberedit.lists.instructorLevelId = <?= $Page->instructorLevelId->toClientList($Page) ?>;
    fschool_memberedit.lists.judgeLevelId = <?= $Page->judgeLevelId->toClientList($Page) ?>;
    fschool_memberedit.lists.marketingSourceId = <?= $Page->marketingSourceId->toClientList($Page) ?>;
    loadjs.done("fschool_memberedit");
});
</script>
<script>
...
<?php } ?>
<form name="fschool_memberedit" id="fschool_memberedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<div class="ew-nav<?= $Page->MultiPages->containerClasses() ?>" id="pages_SchoolMemberEdit"><!-- multi-page tabs -->
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id"<?= $Page->id->rowAttributes() ?>>
        <label id="elh_school_member_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->id->cellAttributes() ?>>
<span id="el_school_member_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
<input type="hidden" data-table="school_member" data-field="x_id" data-hidden="1" data-page="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fschool_memberedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fschool_memberedit", "x_birthdate", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<?php $Page->countryId->EditAttrs->prepend("onchange", "ew.updateOptions.call(this);"); ?>
    <select
        ...
        data-select2-id="fschool_memberedit_x_countryId"
        data-table="school_member"
...
<script>
loadjs.ready("fschool_memberedit", function() {
    var options = { name: "x_countryId", selectId: "fschool_memberedit_x_countryId" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fschool_memberedit.lists.countryId.lookupOptions.length) {
        options.data = { id: "x_countryId", form: "fschool_memberedit" };
    } else {
        options.ajax = { id: "x_countryId", form: "fschool_memberedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<?php $Page->UFId->EditAttrs->prepend("onchange", "ew.updateOptions.call(this);"); ?>
    <select
        ...
        data-select2-id="fschool_memberedit_x_UFId"
        data-table="school_member"
        data-field="x_UFId"
        data-page="1"
...
<script>
loadjs.ready("fschool_memberedit", function() {
    var options = { name: "x_UFId", selectId: "fschool_memberedit_x_UFId" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fschool_memberedit.lists.UFId.lookupOptions.length) {
        options.data = { id: "x_UFId", form: "fschool_memberedit" };
    } else {
        options.ajax = { id: "x_UFId", form: "fschool_memberedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_school_member_cityId">
    <select
        ...
        data-select2-id="fschool_memberedit_x_cityId"
        data-table="school_member"
        data-field="x_cityId"
        data-page="1"
...
<script>
loadjs.ready("fschool_memberedit", function() {
    var options = { name: "x_cityId", selectId: "fschool_memberedit_x_cityId" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fschool_memberedit.lists.cityId.lookupOptions.length) {
        options.data = { id: "x_cityId", form: "fschool_memberedit" };
    } else {
        options.ajax = { id: "x_cityId", form: "fschool_memberedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
loadjs.ready(["fschool_memberedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fschool_memberedit", "x_fatherBirthdate", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fschool_memberedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fschool_memberedit", "x_motherBirthdate", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<span id="el_school_member_modalityId">
    <select
        ...
        data-select2-id="fschool_memberedit_x_modalityId"
        data-table="school_member"
...
<script>
loadjs.ready("fschool_memberedit", function() {
    var options = { name: "x_modalityId", selectId: "fschool_memberedit_x_modalityId" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fschool_memberedit.lists.modalityId.lookupOptions.length) {
        options.data = { id: "x_modalityId", form: "fschool_memberedit" };
    } else {
        options.ajax = { id: "x_modalityId", form: "fschool_memberedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<div class="form-check d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->instructorStatus->isInvalidClass() ?>" data-table="school_member" data-field="x_instructorStatus" data-page="4" name="x_instructorStatus[]" id="x_instructorStatus_624833" value="1"<?= ConvertToBool($Page->instructorStatus->CurrentValue) ? " checked" : "" ?><?= $Page->instructorStatus->editAttributes() ?> aria-describedby="x_instructorStatus_help">
...
<?php $Page->martialArtId->EditAttrs->prepend("onchange", "ew.updateOptions.call(this);"); ?>
    <select
        ...
        data-select2-id="fschool_memberedit_x_martialArtId"
        data-table="school_member"
...
<script>
loadjs.ready("fschool_memberedit", function() {
    var options = { name: "x_martialArtId", selectId: "fschool_memberedit_x_martialArtId" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fschool_memberedit.lists.martialArtId.lookupOptions.length) {
        options.data = { id: "x_martialArtId", form: "fschool_memberedit" };
    } else {
        options.ajax = { id: "x_martialArtId", form: "fschool_memberedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_school_member_rankId">
    <select
        ...
        data-select2-id="fschool_memberedit_x_rankId"
        data-table="school_member"
        data-field="x_rankId"
        data-page="4"
...
<script>
loadjs.ready("fschool_memberedit", function() {
    var options = { name: "x_rankId", selectId: "fschool_memberedit_x_rankId" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fschool_memberedit.lists.rankId.lookupOptions.length) {
        options.data = { id: "x_rankId", form: "fschool_memberedit" };
    } else {
        options.ajax = { id: "x_rankId", form: "fschool_memberedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_school_member_schoolId">
    <select
        ...
        data-select2-id="fschool_memberedit_x_schoolId"
        data-table="school_member"
...
<script>
loadjs.ready("fschool_memberedit", function() {
    var options = { name: "x_schoolId", selectId: "fschool_memberedit_x_schoolId" };
    if (fschool_memberedit.lists.schoolId.lookupOptions.length) {
        options.data = { id: "x_schoolId", form: "fschool_memberedit" };
    } else {
        options.ajax = { id: "x_schoolId", form: "fschool_memberedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_school_member_memberLevelId">
    <select
        ...
        data-select2-id="fschool_memberedit_x_memberLevelId"
        data-table="school_member"
...
<script>
loadjs.ready("fschool_memberedit", function() {
    var options = { name: "x_memberLevelId", selectId: "fschool_memberedit_x_memberLevelId" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fschool_memberedit.lists.memberLevelId.lookupOptions.length) {
        options.data = { id: "x_memberLevelId", form: "fschool_memberedit" };
    } else {
        options.ajax = { id: "x_memberLevelId", form: "fschool_memberedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_school_member_instructorLevelId">
    <select
        ...
        data-select2-id="fschool_memberedit_x_instructorLevelId"
        data-table="school_member"
...
<script>
loadjs.ready("fschool_memberedit", function() {
    var options = { name: "x_instructorLevelId", selectId: "fschool_memberedit_x_instructorLevelId" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fschool_memberedit.lists.instructorLevelId.lookupOptions.length) {
        options.data = { id: "x_instructorLevelId", form: "fschool_memberedit" };
    } else {
        options.ajax = { id: "x_instructorLevelId", form: "fschool_memberedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_school_member_judgeLevelId">
    <select
        ...
        data-select2-id="fschool_memberedit_x_judgeLevelId"
        data-table="school_member"
...
<script>
loadjs.ready("fschool_memberedit", function() {
    var options = { name: "x_judgeLevelId", selectId: "fschool_memberedit_x_judgeLevelId" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fschool_memberedit.lists.judgeLevelId.lookupOptions.length) {
        options.data = { id: "x_judgeLevelId", form: "fschool_memberedit" };
    } else {
        options.ajax = { id: "x_judgeLevelId", form: "fschool_memberedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_school_member_marketingSourceId">
    <select
        ...
        data-select2-id="fschool_memberedit_x_marketingSourceId"
        data-table="school_member"
...
<script>
loadjs.ready("fschool_memberedit", function() {
    var options = { name: "x_marketingSourceId", selectId: "fschool_memberedit_x_marketingSourceId" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fschool_memberedit.lists.marketingSourceId.lookupOptions.length) {
        options.data = { id: "x_marketingSourceId", form: "fschool_memberedit" };
    } else {
        options.ajax = { id: "x_marketingSourceId", form: "fschool_memberedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
