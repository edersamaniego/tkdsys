...
// Page object
$FedApplicationschoolEdit = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { fed_applicationschool: currentTable } });
var currentForm, currentPageID;
var ffed_applicationschooledit;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    ffed_applicationschooledit = new ew.Form("ffed_applicationschooledit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = ffed_applicationschooledit;

    // Add fields
    var fields = currentTable.fields;
    ffed_applicationschooledit.addFields([
    ...
    // Form_CustomValidate
    ffed_applicationschooledit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ffed_applicationschooledit.validateRequired = ew.CLIENT_VALIDATE;

    // Multi-Page
    ffed_applicationschooledit.multiPage = new ew.MultiPage("ffed_applicationschooledit");

    // Dynamic selection lists
    ffed_applicationschooledit.lists.countryId = <?= $Page->countryId->toClientList($Page) ?>;
    ffed_applicationschooledit.lists.UFId = <?= $Page->UFId->toClientList($Page) ?>;
    ffed_applicationschooledit.lists.cityId = <?= $Page->cityId->toClientList($Page) ?>;
    ffed_applicationschooledit.lists.ownerCountryId = <?= $Page->ownerCountryId->toClientList($Page) ?>;
    ffed_applicationschooledit.lists.ownerStateId = <?= $Page->ownerStateId->toClientList($Page) ?>;
    ffed_applicationschooledit.lists.ownCityId = <?= $Page->ownCityId->toClientList($Page) ?>;
    ffed_applicationschooledit.lists.ownerGraduation = <?= $Page->ownerGraduation->toClientList($Page) ?>;
    ffed_applicationschooledit.lists.ownerMaritalStatus = <?= $Page->ownerMaritalStatus->toClientList($Page) ?>;
    ffed_applicationschooledit.lists.propertySituation = <?= $Page->propertySituation->toClientList($Page) ?>;
    loadjs.done("ffed_applicationschooledit");
});
</script>
<script>
...
<?php } ?>
<form name="ffed_applicationschooledit" id="ffed_applicationschooledit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<div class="ew-nav<?= $Page->MultiPages->containerClasses() ?>" id="pages_FedApplicationschoolEdit"><!-- multi-page tabs -->
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id"<?= $Page->id->rowAttributes() ?>>
        <label id="elh_fed_applicationschool_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->id->cellAttributes() ?>>
<span id="el_fed_applicationschool_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
<input type="hidden" data-table="fed_applicationschool" data-field="x_id" data-hidden="1" data-page="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="ffed_applicationschooledit_x_countryId"
...
<script>
loadjs.ready("ffed_applicationschooledit", function() {
    var options = { name: "x_countryId", selectId: "ffed_applicationschooledit_x_countryId" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ffed_applicationschooledit.lists.countryId.lookupOptions.length) {
        options.data = { id: "x_countryId", form: "ffed_applicationschooledit" };
    } else {
        options.ajax = { id: "x_countryId", form: "ffed_applicationschooledit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<?php $Page->UFId->EditAttrs->prepend("onchange", "ew.updateOptions.call(this);"); ?>
    <select
        ...
        data-select2-id="ffed_applicationschooledit_x_UFId"
        data-table="fed_applicationschool"
        data-field="x_UFId"
        data-page="1"
...
<script>
loadjs.ready("ffed_applicationschooledit", function() {
    var options = { name: "x_UFId", selectId: "ffed_applicationschooledit_x_UFId" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ffed_applicationschooledit.lists.UFId.lookupOptions.length) {
        options.data = { id: "x_UFId", form: "ffed_applicationschooledit" };
    } else {
        options.ajax = { id: "x_UFId", form: "ffed_applicationschooledit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_fed_applicationschool_cityId">
    <select
        ...
        data-select2-id="ffed_applicationschooledit_x_cityId"
        data-table="fed_applicationschool"
        data-field="x_cityId"
        data-page="1"
...
<script>
loadjs.ready("ffed_applicationschooledit", function() {
    var options = { name: "x_cityId", selectId: "ffed_applicationschooledit_x_cityId" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ffed_applicationschooledit.lists.cityId.lookupOptions.length) {
        options.data = { id: "x_cityId", form: "ffed_applicationschooledit" };
    } else {
        options.ajax = { id: "x_cityId", form: "ffed_applicationschooledit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<script>
loadjs.ready(["ffed_applicationschooledit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ffed_applicationschooledit", "x_openingDate", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["ffed_applicationschooledit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ffed_applicationschooledit", "x_birthDateOwner", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="ffed_applicationschooledit_x_ownerCountryId"
        data-table="fed_applicationschool"
...
<script>
loadjs.ready("ffed_applicationschooledit", function() {
    var options = { name: "x_ownerCountryId", selectId: "ffed_applicationschooledit_x_ownerCountryId" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ffed_applicationschooledit.lists.ownerCountryId.lookupOptions.length) {
        options.data = { id: "x_ownerCountryId", form: "ffed_applicationschooledit" };
    } else {
        options.ajax = { id: "x_ownerCountryId", form: "ffed_applicationschooledit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="ffed_applicationschooledit_x_ownerStateId"
        data-table="fed_applicationschool"
...
<script>
loadjs.ready("ffed_applicationschooledit", function() {
    var options = { name: "x_ownerStateId", selectId: "ffed_applicationschooledit_x_ownerStateId" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ffed_applicationschooledit.lists.ownerStateId.lookupOptions.length) {
        options.data = { id: "x_ownerStateId", form: "ffed_applicationschooledit" };
    } else {
        options.ajax = { id: "x_ownerStateId", form: "ffed_applicationschooledit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="ffed_applicationschooledit_x_ownCityId"
        data-table="fed_applicationschool"
...
<script>
loadjs.ready("ffed_applicationschooledit", function() {
    var options = { name: "x_ownCityId", selectId: "ffed_applicationschooledit_x_ownCityId" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ffed_applicationschooledit.lists.ownCityId.lookupOptions.length) {
        options.data = { id: "x_ownCityId", form: "ffed_applicationschooledit" };
    } else {
        options.ajax = { id: "x_ownCityId", form: "ffed_applicationschooledit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_fed_applicationschool_ownerGraduation">
    <select
        ...
        data-select2-id="ffed_applicationschooledit_x_ownerGraduation"
        data-table="fed_applicationschool"
...
<script>
loadjs.ready("ffed_applicationschooledit", function() {
    var options = { name: "x_ownerGraduation", selectId: "ffed_applicationschooledit_x_ownerGraduation" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ffed_applicationschooledit.lists.ownerGraduation.lookupOptions.length) {
        options.data = { id: "x_ownerGraduation", form: "ffed_applicationschooledit" };
    } else {
        options.ajax = { id: "x_ownerGraduation", form: "ffed_applicationschooledit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<?php
    if (in_array("fed_school", explode(",", $Page->getCurrentDetailTable())) && $fed_school->DetailEdit) {
?>
...
?>
<?php
    if (in_array("fed_licenseschool", explode(",", $Page->getCurrentDetailTable())) && $fed_licenseschool->DetailEdit) {
?>
