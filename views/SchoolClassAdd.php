...
var fschool_classadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fschool_classadd = new ew.Form("fschool_classadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fschool_classadd;

    // Add fields
    var fields = currentTable.fields;
    fschool_classadd.addFields([
    ...
    // Form_CustomValidate
    fschool_classadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fschool_classadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fschool_classadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fschool_classadd" id="fschool_classadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<span id="el_school_class_schoolId">
    <select
        ...
        data-select2-id="fschool_classadd_x_schoolId"
...
<script>
loadjs.ready("fschool_classadd", function() {
    var options = { name: "x_schoolId", selectId: "fschool_classadd_x_schoolId" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fschool_classadd.lists.schoolId.lookupOptions.length) {
        options.data = { id: "x_schoolId", form: "fschool_classadd" };
    } else {
        options.ajax = { id: "x_schoolId", form: "fschool_classadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<script>
loadjs.ready(["fschool_classadd", "timepicker"], () => ew.createTimePicker("fschool_classadd", "x_beginnigTime", Object.assign({"step":15}, { timeFormat: "<?= DateFormat(4) ?>" })));
</script>
<?php } ?>
</span>
</div></div>
...
<script>
loadjs.ready(["fschool_classadd", "timepicker"], () => ew.createTimePicker("fschool_classadd", "x_endingTime", Object.assign({"step":15}, { timeFormat: "<?= DateFormat(4) ?>" })));
</script>
<?php } ?>
</span>
</div></div>
