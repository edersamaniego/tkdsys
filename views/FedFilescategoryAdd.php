...
// Page object
$FedFilescategoryAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { fed_filescategory: currentTable } });
var currentForm, currentPageID;
var ffed_filescategoryadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    ffed_filescategoryadd = new ew.Form("ffed_filescategoryadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = ffed_filescategoryadd;

    // Add fields
    var fields = currentTable.fields;
    ffed_filescategoryadd.addFields([
    ...
    // Form_CustomValidate
    ffed_filescategoryadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ffed_filescategoryadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("ffed_filescategoryadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="ffed_filescategoryadd" id="ffed_filescategoryadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["ffed_filescategoryadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ffed_filescategoryadd", "x_createDate", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
