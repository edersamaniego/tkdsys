...
// Page object
$FinCreditorsAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { fin_creditors: currentTable } });
var currentForm, currentPageID;
var ffin_creditorsadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    ffin_creditorsadd = new ew.Form("ffin_creditorsadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = ffin_creditorsadd;

    // Add fields
    var fields = currentTable.fields;
    ffin_creditorsadd.addFields([
    ...
    // Form_CustomValidate
    ffin_creditorsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ffin_creditorsadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    ffin_creditorsadd.lists.masterSchoolId = <?= $Page->masterSchoolId->toClientList($Page) ?>;
    loadjs.done("ffin_creditorsadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="ffin_creditorsadd" id="ffin_creditorsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
