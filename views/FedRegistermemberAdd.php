...
// Page object
$FedRegistermemberAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { fed_registermember: currentTable } });
var currentForm, currentPageID;
var ffed_registermemberadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    ffed_registermemberadd = new ew.Form("ffed_registermemberadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = ffed_registermemberadd;

    // Add fields
    var fields = currentTable.fields;
    ffed_registermemberadd.addFields([
    ...
    // Form_CustomValidate
    ffed_registermemberadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ffed_registermemberadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("ffed_registermemberadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="ffed_registermemberadd" id="ffed_registermemberadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["ffed_registermemberadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ffed_registermemberadd", "x_createDate", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
