...
class ExportReportWord
{
    ...
    public function __invoke($page, $html)
    {
        ...
        $phpword->getCompatibility()->setOoxmlVersion($page->ExportWordVersion);
        $section = $phpword->createSection(["PaperSize" => $tbl->ExportWordPageSize, "orientation" => $tbl->ExportWordPageOrientation]); // Note: Set paper size first
