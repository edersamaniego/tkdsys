...
$LANGUAGES = [["en-US","","english.xml"],["pt-BR","","portuguese.xml"],["es","","spanish.xml"]];
...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'dcWfKnwcHvPRmX9J', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/school.css", // Project stylesheet file name
    ...
    "ADMIN_PASSWORD" => "#5ch00l4dm1n#", // Administrator password
    ...
    "USER_TABLE_NAME" => "school_users",
    "LOGIN_USERNAME_FIELD_NAME" => "email",
    "LOGIN_PASSWORD_FIELD_NAME" => "password",
    "USER_ID_FIELD_NAME" => "schoolId",
    "PARENT_USER_ID_FIELD_NAME" => "schoolIdMaster",
    "USER_LEVEL_FIELD_NAME" => "level",
    "USER_PROFILE_FIELD_NAME" => "profileField",
    "REGISTER_ACTIVATE_FIELD_NAME" => "activateEmail",
    ...
    // User table filters
    "USER_TABLE_DBID" => "DB",
    "USER_TABLE" => "`school_users`",
    "USER_NAME_FILTER" => "(`email` = '%u')",
    "USER_ID_FILTER" => "(`schoolId` = %u)",
    "USER_EMAIL_FILTER" => "(`email` = '%e')",
    "USER_ACTIVATE_FILTER" => "(`activateEmail` = 1)",
    ...
    // Email
    "SENDER_EMAIL" => "noreply@masmartialarts.com", // Sender email address
